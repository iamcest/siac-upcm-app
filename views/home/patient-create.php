            ...
            <v-container fluid>
                <v-form>
                    <v-row>
                        <v-col cols="12" sm="6">
                            <label>Nombre</label>
                            <v-text-field class="mt-3" v-model="appointment_calendar.patient.first_name" outlined></v-text-field>
                        </v-col>
                        <v-col cols="12" sm="6">
                            <label>Apellido</label>
                            <v-text-field class="mt-3" v-model="appointment_calendar.patient.last_name" outlined></v-text-field>
                        </v-col>
                        <v-col cols="12" sm="6">
                            <label>Documento de identidad</label>
                            <v-select class="mt-3" v-model="appointment_calendar.patient.document_type" :items="document_types"
                                item-text="text" item-value="value" outlined></v-select>
                        </v-col>
                        <v-col cols="12" sm="6">
                            <label>N° de identificación</label>
                            <v-text-field class="mt-3" v-model="appointment_calendar.patient.document_id" outlined></v-text-field>
                        </v-col>
                        <v-col cols="12" sm="6">
                            ...
                            <v-dialog ref="birthdate_dialog" v-model="appointment_calendar.birthdate_modal"
                                ...
                                <template #activator="{ on, attrs }">
                                    <v-text-field class="mt-3" v-model="appointment_calendar.patient.birthdate" append-icon="mdi-calendar"
                                ...
                                <v-date-picker v-model="appointment_calendar.patient.birthdate" locale="es" scrollable>
                                    ...
                                    <v-btn text color="primary" @click="$refs.birthdate_dialog.save(appointment_calendar.patient.birthdate)">
                                        OK
                                    </v-btn>
                                </v-date-picker>
                            </v-dialog>
                        ...
                        <v-col cols="12" sm="6">
                            <label>Género</label>
                            <v-select class="mt-3" v-model="appointment_calendar.patient.gender" :items="genders" item-text="appointment_calendar.name"
                                item-value="appointment_calendar.gender" outlined></v-select>
                        </v-col>
                        <v-col cols="12" sm="6">
                            <label>Dirección</label>
                            <v-text-field class="mt-3" v-model="appointment_calendar.patient.address" outlined></v-text-field>
                        </v-col>
                        <v-col cols="12" sm="6">
                            <label>Correo electrónico</label>
                            <v-text-field class="mt-3" v-model="appointment_calendar.patient.email" outlined></v-text-field>
                        </v-col>
                        <v-col cols="12" sm="6" md="4">
                            <label>Teléfono</label>
                            <vue-tel-input-vuetify id="tel-input" class="mt-3" label="" v-model="appointment_calendar.patient.telephone"
                        ...
                        <v-col cols="12" md="4">
                            ...
                            <v-row class="pt-0">
                                <v-col cols="4" class="whatsapp-platform">
                                    <v-checkbox v-model="appointment_calendar.patient.whatsapp" :true-value="parseInt(1)"
                                        :false-value="parseInt(0)" prepend-icon="mdi-whatsapp"></v-checkbox>
                                </v-col>
                                <v-col cols="4" class="telegram-platform">
                                    <v-checkbox v-model="appointment_calendar.patient.telegram" :true-value="parseInt(1)"
                        ...
                        <v-col cols="12" sm="6" md="4">
                            ...
                            <v-dialog ref="entry_date_dialog" v-model="appointment_calendar.entry_date_modal"
                                ...
                                <template #activator="{ on, attrs }">
                                    <v-text-field class="mt-3" v-model="appointment_calendar.patient.entry_date" append-icon="mdi-calendar"
                                        readonly v-bind="attrs" v-on="on" outlined>
                                    </v-text-field>
                                </template>
                        ...
                        <v-col cols="12">
                            <v-btn class="secondary white--text" @click="appointment_calendar.savePatient" :loading="appointment_calendar.patient_create_loading"
                                block>Guardar</v-btn>
                        </v-col>
                    </v-row>
