<v-row>
    <v-col cols="12">
        ...
        <v-checkbox label="Acceso" v-model="upcm_invitations.editedItem.access.patient_material_access.access" :true-value="1" :false-value="0"></v-checkbox>
    </v-col>
    <v-col cols="12" md="6" v-for="section in upcm_invitations.editedItem.access.patient_material_access.sections" v-if="upcm_invitations.editedItem.access.patient_material_access.access">
        <h6 class="text-h6">
            {{ section.name }}
        </h6>
        <v-row>
