          ...
          <v-form>
            <v-row class="px-16 mx-auto">
              ...
              <v-col cols="12" md="6">
                ...
                <v-text-field class="mt-3" v-model="calc.max_pressure" suffix="mmHg" :counter="6" outlined required ></v-text-field>
              </v-col>              

              <v-col cols="12" md="6">
                <label>Diabetes</label>
                <v-select class="mt-3" v-model="calc.diabete" outlined ></v-select>
              </v-col>

              <v-col cols="12" md="6">
                <label>Colesterol total (md/dl)</label>
                <v-text-field class="mt-3" v-model="calc.total_cholesterol" suffix="md/dl" :counter="6" outlined required ></v-text-field>
              </v-col>
