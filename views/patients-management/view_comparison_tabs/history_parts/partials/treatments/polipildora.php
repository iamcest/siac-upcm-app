                    ...
                    <v-row>
                        <v-col cols="12">
                            <p class="font-weight-bold black--text text-center">Toma polipildora:
                                <template
                                    v-if="comparison.history.<?= $item ?>.history_content.treatments.polipildora.active">
                                    Sí
                                </template>
                                <template v-else>
                                    No
                            ...
                            <template
                                ...
                                <p class="font-weight-bold black--text text-center">Es candidato:
                                    <template
                                        v-if="comparison.history.<?= $item ?>.history_content.treatments.polipildora.candidate">
                                        Sí
                                    </template>
                                    <template v-else>
                                        No
                                ...
                                <template
                                    ...
                                    <p class="font-weight-bold black--text text-center"
                                        v-if="comparison.history.<?= $item ?>.history_content.treatments.polipildora.reason.length > 0">
                                        <b>Razón:</b>
                                        <br>
                                    <p class="font-weight-normal black--text text-center"
                                        v-for="item in comparison.history.<?= $item ?>.history_content.treatments.polipildora.reason">
                                        -{{item}}
                                    </p>
                                    <v-row justify="center">
                                        <v-col cols="12" md="4" lg="3"
                                            v-for="item in comparison.history.<?= $item ?>.history_content.treatments.polipildora.selected">
