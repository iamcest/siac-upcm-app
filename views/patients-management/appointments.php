                              ...
                              <v-form>
                                  <v-row>
                                      ...
                                      <v-col cols="12" sm="6">
                                          ...
                                          <v-select class="mt-3" v-model="form.user_id" :search-input.sync="search"
                                              :items="doctors" item-text="full_name" item-value="user_id" outlined>
                                          </v-select>
                                      </v-col>
                                      <v-col cols="12" sm="6">
                                      ...
                                      <v-col cols="12" sm="6">
                                          ...
                                          <v-select class="mt-3" v-model="form.appointment_type"
                                              :items="appointment_types" outlined></v-select>
                                      </v-col>
                                      <v-col cols="12" sm="6">
                                      ...
                                      <v-col cols="12" sm="6">
                                          ...
                                          <v-dialog ref="appointment_time_dialog" v-model="appointment_time_modal"
                                              ...
                                              <v-time-picker v-if="appointment_time_modal"
                                                  v-model="form.appointment_time" full-width>
                                                  <v-spacer></v-spacer>
                      ...
                      <v-card-text v-if="dialog">
                          <v-container fluid>
                              <v-row>
                                  <v-col cols="12" sm="6">
                                      <p class="black--text text-h6"><strong>N° de historia:</strong>
                                          <span
                                              class="font-weight-light">{{ appointment_selected.props.patient_id }}</span>
                                      </p>
                                  </v-col>
                                  <v-col cols="12" sm="6">
                                  ...
                                  <v-col cols="12" sm="6">
                                      <p class="black--text text-h6"><strong>Motivo de la cita:</strong>
                                          <span
                                              class="font-weight-light">{{ appointment_selected.props.appointment_reason }}</span>
                                      </p>
                                  </v-col>
                                  <v-col cols="12" sm="6">
                                      <p class="black--text text-h6"><strong>Tipo de cita:</strong>
                                          <span
                                              class="font-weight-light">{{ appointment_selected.props.appointment_type }}</span>
                                      </p>
                                  </v-col>
                                  <v-col cols="12" sm="6">
                                  ...
                                  <v-col cols="12" sm="6">
                                      <p class="black--text text-h6"><strong>Hora:</strong>
                                          <span
                                              class="font-weight-light">{{ appointment_selected.props.appointment_time }}</span>
                                      </p>
                                  </v-col>
                              </v-row>
                              <v-divider></v-divider>
                              <v-row>
                                  ...
                                  <v-col cols="12">
                                      <v-data-table :headers="headers" :items="patient_appointments"
                                          sort-by="appointment_date" :sort-desc="true" class="elevation-1 full-width">
                                          <template #no-data>
                          ...
                          <v-container fluid>
                              <v-form>
                                  <v-row>
                                      <v-col cols="12" sm="6">
                                          <label>Nombre</label>
                                          <v-text-field class="mt-3" v-model="patient.first_name" outlined>
                                          </v-text-field>
                                      </v-col>
                                      <v-col cols="12" sm="6">
                                          <label>Apellido</label>
                                          <v-text-field class="mt-3" v-model="patient.last_name" outlined>
                                          </v-text-field>
                                      </v-col>
                                      <v-col cols="12" sm="6">
                                      ...
                                      <v-col cols="12" sm="6">
                                          ...
                                          <v-text-field class="mt-3" v-model="patient.document_id" outlined>
                                          </v-text-field>
                                      </v-col>
                                      <v-col cols="12" sm="6">
                                          ...
                                          <v-dialog ref="birthdate_dialog" v-model="birthdate_modal"
                                              ...
                                              <template #activator="{ on, attrs }">
                                                  <v-text-field class="mt-3" v-model="patient.birthdate"
                                                      append-icon="mdi-calendar" readonly v-bind="attrs" v-on="on"
                                                      outlined></v-text-field>
                                              </template>
                                              <v-date-picker v-model="patient.birthdate" locale="es" scrollable>
                                                  ...
                                                  <v-btn text color="primary"
                                                      @click="$refs.birthdate_dialog.save(patient.birthdate)">
                                                      OK
                                                  </v-btn>
                                              </v-date-picker>
                                          </v-dialog>
                                      ...
                                      <v-col cols="12" sm="6">
                                          <label>Género</label>
                                          <v-select class="mt-3" v-model="patient.gender" :items="genders"
                                              item-text="name" item-value="gender" outlined></v-select>
                                      </v-col>
                                      <v-col cols="12" sm="6">
                                      ...
                                      <v-col cols="12" sm="6" md="4">
                                          ...
                                          <vue-tel-input-vuetify id="tel-input" class="mt-3" label=""
                                              v-model="patient.telephone" mode="international"
                                          ...
                                          <v-row class="pt-0">
                                              <v-col cols="4" class="whatsapp-platform">
                                                  <v-checkbox v-model="patient.whatsapp" :true-value="parseInt(1)"
                                                      :false-value="parseInt(0)" prepend-icon="mdi-whatsapp">
                                                  </v-checkbox>
                                              </v-col>
                                              <v-col cols="4" class="telegram-platform">
                                                  <v-checkbox v-model="patient.telegram" :true-value="parseInt(1)"
                                                      :false-value="parseInt(0)" prepend-icon="mdi-telegram">
                                                  </v-checkbox>
                                              </v-col>
                                      ...
                                      <v-col cols="12" sm="6" md="4">
                                          ...
                                          <v-dialog ref="entry_date_dialog" v-model="entry_date_modal"
                                              ...
                                              <template #activator="{ on, attrs }">
                                                  <v-text-field class="mt-3" v-model="patient.entry_date"
                                                      append-icon="mdi-calendar" readonly v-bind="attrs" v-on="on"
                                                      outlined></v-text-field>
                                              </template>
                                      ...
                                      <v-col cols="12">
                                          <v-btn class="secondary white--text" @click="savePatient"
                                              :loading="patient_create_loading" block>Guardar</v-btn>
                                      </v-col>
                                  </v-row>
