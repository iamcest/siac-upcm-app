    ...
    <v-card class="px-2 py-10" width="100%">
        <v-row>
            ...
            <v-col cols="12" class="d-flex justify-center"
                v-if="!patient_history.form.history_content.cardiovascular_diseases.ischemic_cardiopathy.active">
                ...
                <v-col cols="12" md="6">
                    <v-card class="px-4" outlined>
                        ...
                        <v-row
                            ...
                            <v-col cols="12" v-if="patient_history.form.history_content.cardiovascular_diseases.ischemic_cardiopathy.sca.im.length > 1 &&
                                i != 0">
                                <v-divider></v-divider>
                            </v-col>
                            <v-col cols="12" lg="6">
