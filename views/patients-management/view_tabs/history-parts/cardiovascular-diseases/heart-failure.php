                ...
                <v-row>
                    <v-col cols="12">
                        <span class="black--text font-weight-bold">
                            <template
                                v-if="patient_history.form.history_content.cardiovascular_diseases.heart_failure.active">
                                Sí
                            </template>
                            <template v-else>
                                No
                    ...
                    <template v-if="patient_history.form.history_content.cardiovascular_diseases.heart_failure.active">
                        <v-col cols="12">
                            <span class="black--text font-weight-bold">Dx año:
                                {{ getOnlyYear(patient_history.form.history_content.cardiovascular_diseases.heart_failure.dx_age) }}
                            </span>
                        </v-col>
                        <v-col cols="12">
                            <span class="black--text font-weight-bold">Clase funcional NYHA:
                                {{ patient_history.form.history_content.cardiovascular_diseases.heart_failure.functional_class }}
                            </span>
                        </v-col>
                    </template>
                </v-row>
