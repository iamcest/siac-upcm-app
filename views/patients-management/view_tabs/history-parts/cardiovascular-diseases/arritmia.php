<v-container>
    <v-card class="px-2 py-10" width="100%">
        <v-row>
            ...
            <template v-if="patient_history.form.history_content.cardiovascular_diseases.arritmia.active"
                v-for="item in patient_history.form.history_content.cardiovascular_diseases.arritmia.items">
                ...
                <v-col cols="12" v-if="patient_history.form.history_content.cardiovascular_diseases.arritmia.items.length > 1">
                    <v-divider></v-divider>
                </v-col>
            </template>
