            ...
            <v-row>
                <v-col cols="12">
                    ...
                    <span class="black--text font-weight-bold">
                        {{ patient_history.form.history_content.treatments.antithrombotics.antiplatelet_agents.treatment }} </span>
                </v-col>
                <v-col class="mt-n4" cols="12">
                    <span class="black--text font-weight-bold">Dosis diarias:
                        {{ patient_history.form.history_content.treatments.antithrombotics.antiplatelet_agents.dosis}}</span>
                    <template
                ...
                <v-col class="mt-n4" cols="12">
                    <span class="black--text font-weight-bold">Frecuencia:
                        {{ patient_history.form.history_content.treatments.antithrombotics.antiplatelet_agents.frecuency }}</span>
                </v-col>
                <v-col class="mt-n4" cols="12">
                ...
                <v-col class="mt-n4" cols="12"
                    ...
                    <span class="black--text font-weight-bold">Tipo de reacción:
                        {{ patient_history.form.history_content.treatments.antithrombotics.antiplatelet_agents.secondary_effects }}</span>
                </v-col>
            </v-row>
        </v-col>
        <v-col cols="6" md="4">
            <v-row>
                <v-col cols="12">
                    ...
                    <span class="black--text font-weight-bold">
                        {{ patient_history.form.history_content.treatments.antithrombotics.oral_anticoagulants.treatment }} </span>
                </v-col>
                <v-col class="mt-n4" cols="12">
                    <span class="black--text font-weight-bold">Dosis diarias:
                        {{ patient_history.form.history_content.treatments.antithrombotics.oral_anticoagulants.dosis}}</span>
                    <template
                        v-if="patient_appointments.previous_appointment.hasOwnProperty('appointment_id') && patient_history.items.length > 1">
                        <v-badge color="primary"
                ...
                <v-col class="mt-n4" cols="12">
                    <span class="black--text font-weight-bold">Frecuencia:
                        {{ patient_history.form.history_content.treatments.antithrombotics.oral_anticoagulants.frecuency }} </span>
                </v-col>
                <v-col class="mt-n4" cols="12">
                    <span class="black--text font-weight-bold">Reacciones adversas:
                        <template
                ...
                <v-col class="mt-n4" cols="12"
                    v-if="patient_history.form.history_content.treatments.antithrombotics.oral_anticoagulants.has_secondary_effects">
                    <span class="black--text font-weight-bold">Tipo de reacción:
                        {{ patient_history.form.history_content.treatments.antithrombotics.oral_anticoagulants.secondary_effects }}</span>
                </v-col>
            </v-row>
        </v-col>
    </v-row>
