<v-row class="factor-risk-container mb-10">
    ...
    <v-col cols="6" md="3">
        <v-row>
            ...
            <v-col class="mt-n4" cols="12">
                <span class="black--text font-weight-bold">Reacciones adversas:
                    <template v-if="patient_history.form.history_content.diseases.dtm2.insulin.has_secondary_effects">
                        Sí
                    </template>
                    <template v-else>
                        No
    ...
    <v-col cols="6" md="3">
        <v-row>
            ...
            <v-col class="mt-n4" cols="12">
                <span class="black--text font-weight-bold">Reacciones adversas:
                    <template v-if="patient_history.form.history_content.diseases.dtm2.a_insulin.has_secondary_effects">
                        Sí
                    </template>
                    <template v-else>
                        No
    ...
    <v-col cols="6" md="2">
        <v-row>
            ...
            <v-col class="mt-n4" cols="12">
                <span class="black--text font-weight-bold">Reacciones adversas:
                    <template v-if="patient_history.form.history_content.diseases.dtm2.glinidas.has_secondary_effects">
                        Sí
                    </template>
                    <template v-else>
                        No
    ...
    <v-col cols="6" md="2">
        <v-row>
            ...
            <v-col class="mt-n4" cols="12">
                <span class="black--text font-weight-bold">Reacciones adversas:
                    <template v-if="patient_history.form.history_content.diseases.dtm2.inh_dpp.has_secondary_effects">
                        Sí
                    </template>
                    <template v-else>
                        No
    ...
    <v-col cols="6" md="2">
        <v-row>
            ...
            <v-col class="mt-n4" cols="12">
                <span class="black--text font-weight-bold">Reacciones adversas:
                    <template v-if="patient_history.form.history_content.diseases.dtm2.i_slgt2.has_secondary_effects">
                        Sí
                    </template>
                    <template v-else>
                        No
