        ...
        <v-row>
            ...
            <v-col class="mt-n4" cols="12"
                ...
                <span class="black--text font-weight-bold">Tipo de reacción:
                    {{ patient_history.form.history_content.diseases.dyslipidemia.statins.secondary_effects }} </span>
            </v-col>
        </v-row>
    </v-col>
    <v-col cols="6" md="6" lg="4">
    ...
    <v-col cols="6" md="6" lg="4">
        <v-row>
            ...
            <v-col class="mt-n4" cols="12"
                v-if="patient_history.form.history_content.diseases.dyslipidemia.fibratos.has_secondary_effects">
                <span class="black--text font-weight-bold">Tipo de reacción:
                    {{ patient_history.form.history_content.diseases.dyslipidemia.fibratos.secondary_effects }} </span>
            </v-col>
        </v-row>
    </v-col>
    <v-col cols="6" md="6" lg="4">
        <v-row>
            ...
            <v-col class="mt-n4" cols="12"
                v-if="patient_history.form.history_content.diseases.dyslipidemia.omega3.has_secondary_effects">
                <span class="black--text font-weight-bold">Tipo de reacción:
                    {{ patient_history.form.history_content.diseases.dyslipidemia.omega3.secondary_effects }} </span>
            </v-col>
        </v-row>
    </v-col>
    <v-col cols="6" md="6" lg="4">
        <v-row>
            ...
            <v-col class="mt-n4" cols="12"
                v-if="patient_history.form.history_content.diseases.dyslipidemia.ipcsk9.has_secondary_effects">
                <span class="black--text font-weight-bold">Tipo de reacción:
                    {{ patient_history.form.history_content.diseases.dyslipidemia.ipcsk9.secondary_effects }} </span>
            </v-col>
        </v-row>
    </v-col>
</v-row>
