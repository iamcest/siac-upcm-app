                              ...
                              <v-col cols="12" md="4">
                                ...
                                <v-row class="pt-0">
                                  <v-col cols="4" class="whatsapp-platform">
                                    <v-checkbox v-model="editedItem.whatsapp" :true-value="parseInt(1)" :false-value="parseInt(0)" prepend-icon="mdi-whatsapp" ></v-checkbox>
                                  </v-col>
                                  <v-col cols="4" class="telegram-platform">
                                    <v-checkbox v-model="editedItem.telegram" :true-value="parseInt(1)" :false-value="parseInt(0)" prepend-icon="mdi-telegram" ></v-checkbox>
                                  </v-col>
                                  <v-col cols="4" class="sms-platform">
                                    <v-checkbox v-model="editedItem.sms" :true-value="parseInt(1)" :false-value="parseInt(0)" prepend-icon="mdi-comment-text" ></v-checkbox>
