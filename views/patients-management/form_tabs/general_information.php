...
<template v-if="editedItem.birthdate == '' || editedItem.birthdate == null">
    <v-col cols="12" sm="6">
...
<template v-else>
    <v-row class="d-flex align-center px-3">
        ...
        <v-col cols="12" sm="3" md="3" lg="2">
            <label><span class="subtitle-1"><b>Edad: {{ getTimeDiff(editedItem.birthdate) }} años</b></label></span>
        </v-col>
    </v-row>
</template>
<v-col cols="12" sm="6">
...
<v-col cols="12" md="4">
    ...
    <v-row class="pt-0">
        <v-col cols="4" class="whatsapp-platform">
            <v-checkbox v-model="editedItem.whatsapp" :true-value="'1'" :false-value="'0'" prepend-icon="mdi-whatsapp">
            </v-checkbox>
        </v-col>
        <v-col cols="4" class="telegram-platform">
            <v-checkbox v-model="editedItem.telegram" :true-value="'1'" :false-value="'0'" prepend-icon="mdi-telegram">
            </v-checkbox>
        </v-col>
        <v-col cols="4" class="sms-platform">
            <v-checkbox v-model="editedItem.sms" :true-value="'1'" :false-value="'0'" prepend-icon="mdi-comment-text">
            </v-checkbox>
