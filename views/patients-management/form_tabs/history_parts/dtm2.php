                                        ...
                                        <v-row class="d-flex justify-start">
                                          ...
                                          <template v-if="patient_history.form.history_content.diseases.dtm2.active">
                                            <v-col cols="6" md="4" lg="3">
                                              ...
                                              <v-select v-model="patient_history.form.history_content.diseases.dtm2.controlled" :items="patient_history.select" item-text='text' item-value='value' @change="diagnosticDateCheck(patient_history.form.history_content.diseases.dtm2)" outlined dense>
                                              </v-select>
                                            </v-col>
                                            <v-col cols="6" md="4" lg="3">
                                              <label class="black--text font-weight-bold">Diagnóstico previo:</label>
                                              <v-select v-model="patient_history.form.history_content.diseases.dtm2.detected_previously" :items="patient_history.select" item-text='text' item-value='value' @change="diagnosticDateCheck(patient_history.form.history_content.diseases.dtm2)" outlined dense>
                                              </v-select>
                                            </v-col>
                                            <v-col cols="6" md="4" lg="3" v-if="patient_history.form.history_content.diseases.dtm2.detected_previously">
                                              ...
                                              <v-select v-model="patient_history.form.history_content.diseases.dtm2.diagnostic_date" :items="patient_history.interval_times" item-text='text' item-value='value' outlined dense>
                                              </v-select>
                                            </v-col>
