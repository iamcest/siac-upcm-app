        ...
        <v-row>
            ...
            <v-col class="mt-n4" cols="12">
                ...
                <v-select :items="patient_history.options.treatment_frecuency"
                    v-model="patient_history.form.history_content.diseases.hta.iecas.frecuency" class="black-text mt-3"
            ...
            <v-col class="mt-n4" cols="12"
                ...
                <v-select v-model="patient_history.form.history_content.diseases.hta.iecas.secondary_effects"
                    ...
                    :items="patient_history.form.history_content.diseases.hta.secondary_effects.iecas" outlined dense>
                    <template #prepend-item>
                        <v-list-item>
                            <v-list-item-content>
        ...
        <v-row>
            <v-col cols="12">
                ...
                <v-select v-model="patient_history.form.history_content.diseases.hta.bra.treatment"
                    :items="patient_history.form.history_content.diseases.hta.treatments_list.bra" class="mt-3" outlined
                    dense>
                    <template #prepend-item>
                        <v-list-item>
                            <v-list-item-content>
            ...
            <v-col class="mt-n4" cols="12">
                <label class="black--text font-weight-bold">Frecuencia:</label>
                <v-select :items="patient_history.options.treatment_frecuency"
                    v-model="patient_history.form.history_content.diseases.hta.bra.frecuency" class="black-text mt-3"
                    outlined dense></v-select>
            </v-col>
            <v-col class="mt-n4" cols="12">
                <label class="black--text font-weight-bold">Reacciones adversas:</label>
            ...
            <v-col class="mt-n4" cols="12"
                ...
                <v-select v-model="patient_history.form.history_content.diseases.hta.bra.secondary_effects"
                    ...
                    <template #prepend-item>
                        <v-list-item>
                            <v-list-item-content>
                                <v-text-field ref="hta_bra_se" placeholder="Incluye otra" dense outlined></v-text-field>
                            </v-list-item-content>
                        </v-list-item>
                        <v-btn class="mt-n6" color="primary" text
        ...
        <v-row>
            <v-col cols="12">
                ...
                <v-select v-model="patient_history.form.history_content.diseases.hta.ca.treatment"
                    :items="patient_history.form.history_content.diseases.hta.treatments_list.ca" class="mt-3" outlined
                    dense>
                    <template #prepend-item>
                        <v-list-item>
                            <v-list-item-content>
            ...
            <v-col class="mt-n4" cols="12">
                <v-text-field v-model="patient_history.form.history_content.diseases.hta.ca.dosis" class="mt-3" outlined
                    dense>
            ...
            <v-col class="mt-n4" cols="12"
                ...
                <v-select v-model="patient_history.form.history_content.diseases.hta.ca.secondary_effects"
                    ...
                    <template #prepend-item>
                        <v-list-item>
                            <v-list-item-content>
                                <v-text-field ref="hta_ca_se" placeholder="Incluye otra" dense outlined></v-text-field>
                            </v-list-item-content>
                        </v-list-item>
                        <v-btn class="mt-n6" color="primary" text
        ...
        <v-row>
            <v-col cols="12">
                ...
                <v-select v-model="patient_history.form.history_content.diseases.hta.diuretic.treatment"
                    :items="patient_history.form.history_content.diseases.hta.treatments_list.diuretic" item-text="name"
                    item-value="name" class="mt-3" outlined dense>
                    <template #prepend-item>
                        <v-list-item>
                            <v-list-item-content>
                                <v-text-field ref="hta_diuretic_treatment" placeholder="Incluir otro" dense outlined>
                                </v-text-field>
                            </v-list-item-content>
                        </v-list-item>
                        <v-btn class="mt-n6" color="primary" text
            ...
            <v-col class="mt-n4" cols="12">
                <v-text-field v-model="patient_history.form.history_content.diseases.hta.diuretic.dosis" class="mt-3"
                    outlined dense>
                    <template class="black-text" #prepend>
                        <span class="font-weight-bold">Dosis diarias:</span>
                    </template>
        ...
        <v-row>
            <v-col cols="12">
                ...
                <v-select v-model="patient_history.form.history_content.diseases.hta.ir.treatment"
                    :items="patient_history.form.history_content.diseases.hta.treatments_list.ir" class="mt-3" outlined
                    dense>
                    <template #prepend-item>
                        <v-list-item>
                            <v-list-item-content>
            ...
            <v-col class="mt-n4" cols="12">
                <v-text-field v-model="patient_history.form.history_content.diseases.hta.ir.dosis" class="mt-3" outlined
                    dense>
                    <template class="black-text" #prepend>
                        <span class="font-weight-bold">Dosis diarias:</span>
                    </template>
            ...
            <v-col class="mt-n4" cols="12"
                ...
                <v-select v-model="patient_history.form.history_content.diseases.hta.ir.secondary_effects"
                    ...
                    <template #prepend-item>
                        <v-list-item>
                            <v-list-item-content>
                                <v-text-field ref="hta_ir_se" placeholder="Incluye otra" dense outlined></v-text-field>
                            </v-list-item-content>
                        </v-list-item>
                        <v-btn class="mt-n6" color="primary" text
        ...
        <v-row>
            <v-col cols="12">
                ...
                <v-select v-model="patient_history.form.history_content.diseases.hta.block_beta.treatment"
                    :items="patient_history.form.history_content.diseases.hta.treatments_list.block_beta" class="mt-3"
                    outlined dense>
                    <template #prepend-item>
                        <v-list-item>
                            <v-list-item-content>
                                <v-text-field ref="hta_block_beta_treatment" placeholder="Incluir otro" dense outlined>
                                </v-text-field>
                            </v-list-item-content>
                        </v-list-item>
                        <v-btn class="mt-n6" color="primary" text
            ...
            <v-col class="mt-n4" cols="12">
                <v-text-field v-model="patient_history.form.history_content.diseases.hta.block_beta.dosis" class="mt-3"
                    outlined dense>
                    <template class="black-text" #prepend>
                        <span class="font-weight-bold">Dosis diarias:</span>
                    </template>
            ...
            <v-col class="mt-n4" cols="12">
                <label class="black--text font-weight-bold">Reacciones adversas:</label>
                <v-select v-model="patient_history.form.history_content.diseases.hta.block_beta.has_secondary_effects"
                    class="black-text mt-3" :items="patient_history.select" outlined dense></v-select>
            </v-col>
            <v-col class="mt-n4" cols="12"
    ...
    <v-col cols="6" md="4" lg="3">
        <v-row>
            ...
            <v-col class="mt-n4" cols="12">
                <label class="black--text font-weight-bold">Frecuencia:</label>
                <v-select :items="patient_history.options.treatment_frecuency"
                    v-model="patient_history.form.history_content.diseases.hta.arni.frecuency" class="black-text mt-3"
                    outlined dense></v-select>
            </v-col>
            <v-col class="mt-n4" cols="12">
                <label class="black--text font-weight-bold">Reacciones adversas:</label>
            ...
            <v-col class="mt-n4" cols="12"
                ...
                <v-select v-model="patient_history.form.history_content.diseases.hta.arni.secondary_effects"
                    class="black-text mt-3"
                    :items="patient_history.form.history_content.diseases.hta.secondary_effects.arni" outlined dense>
                    <template #prepend-item>
                        <v-list-item>
                            <v-list-item-content>
    ...
    <v-col cols="6" md="4" lg="3">
        <v-row>
            <v-col cols="12">
                ...
                <label class="black--text font-weight-bold">Tratamiento:</label>
                <v-select v-model="patient_history.form.history_content.diseases.hta.ant_mineralocorticoids.treatment"
            ...
            <v-col class="mt-n4" cols="12">
                <v-text-field v-model="patient_history.form.history_content.diseases.hta.ant_mineralocorticoids.dosis"
                    class="mt-3" outlined dense>
                    <template #prepend>
                        <span class="font-weight-bold">Dosis diarias:</span>
                    </template>
            ...
            <v-col cols="12" md="4" lg="3">
                ...
                <v-col cols="12" v-if="patient_history.form.history_content.diseases.hta.fdc.active">
                    ...
                    <v-select v-model="patient_history.form.history_content.diseases.hta.fdc.selected"
                        ...
                        ref="hta_fdc_select" item-text="name" item-value="name" class="mt-3" multiple outlined dense>
                        <template #prepend-item>
                            <v-row class="px-7">
