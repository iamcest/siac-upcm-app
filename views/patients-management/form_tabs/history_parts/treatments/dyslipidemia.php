    ...
    <v-col cols="6" md="6" lg="4">
        <v-row>
            ...
            <v-col class="mt-n4" cols="12"
                ...
                <v-select v-model="patient_history.form.history_content.diseases.dyslipidemia.statins.secondary_effects"
                    ...
                    <template #prepend-item>
                        <v-list-item>
                            <v-list-item-content>
                                <v-text-field ref="dyslipidemia_statins_se" placeholder="Incluye otra" dense outlined>
                                </v-text-field>
                            </v-list-item-content>
                        </v-list-item>
                        <v-btn class="mt-n6" color="primary" text
            ...
            <v-col class="mt-n8" cols="12"
                v-if="patient_history.form.history_content.diseases.dyslipidemia.statins.treatment !== '' && 
        ...
        <v-row>
            ...
            <template v-if="patient_history.form.history_content.diseases.dyslipidemia.ezt.active">
                ...
                <v-col class="mt-n4" cols="12"
                    ...
                    <label class="black--text font-weight-bold">Tipo de reacción:</label>
                    <v-select v-model="patient_history.form.history_content.diseases.dyslipidemia.ezt.secondary_effects"
                        class="black-text mt-3"
            ...
            <v-col class="mt-n4" cols="12"
                ...
                <v-select
                    ...
                    <template #prepend-item>
                        <v-list-item>
                            <v-list-item-content>
                                <v-text-field ref="dyslipidemia_fibratos_se" placeholder="Incluye otra" dense outlined>
                                </v-text-field>
                            </v-list-item-content>
                        </v-list-item>
                        <v-btn class="mt-n6" color="primary" text
    ...
    <v-col cols="6" md="6" lg="4">
        <v-row>
            ...
            <v-col class="mt-n4" cols="12"
                ...
                <label class="black--text font-weight-bold">Tipo de reacción:</label>
                <v-select v-model="patient_history.form.history_content.diseases.dyslipidemia.omega3.secondary_effects"
                    class="black-text mt-3"
                    ...
                    <template #prepend-item>
                        <v-list-item>
                            <v-list-item-content>
                                <v-text-field ref="dyslipidemia_omega3_se" placeholder="Incluye otra" dense outlined>
                                </v-text-field>
                            </v-list-item-content>
                        </v-list-item>
                        <v-btn class="mt-n6" color="primary" text
    ...
    <v-col cols="6" md="6" lg="4">
        <v-row>
            ...
            <v-col class="mt-n4" cols="12"
                v-if="patient_history.form.history_content.diseases.dyslipidemia.omega3.has_secondary_effects">
                <label class="black--text font-weight-bold">Tipo de reacción:</label>
                <v-select v-model="patient_history.form.history_content.diseases.dyslipidemia.ipcsk9.secondary_effects"
                    class="black-text mt-3"
                    ...
                    <template #prepend-item>
                        <v-list-item>
                            <v-list-item-content>
                                <v-text-field ref="dyslipidemia_ipcsk9_se" placeholder="Incluye otra" dense outlined>
                                </v-text-field>
                            </v-list-item-content>
                        </v-list-item>
                        <v-btn class="mt-n6" color="primary" text
