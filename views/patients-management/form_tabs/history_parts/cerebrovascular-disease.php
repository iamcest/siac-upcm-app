...
<v-row class="factor-risk-container">
    ...
    <template v-if="patient_history.form.history_content.cerebrovascular_disease.active">
        ...
        <v-col cols="12" md="6" class="mt-n4" v-if="patient_history.form.history_content.cerebrovascular_disease.type == 'Isquémico'">
            ...
            :items="['', 'Ataque isquémico transitorio', 'ACV isquémico establecido', 'Infarto cerebral']" outlined dense></v-select>
        </v-col>
    </template>
</v-row>