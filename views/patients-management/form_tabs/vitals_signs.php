        ...
        <v-col class="font-weight-bold text-center" cols="8" offset="2">
            <v-row>
                ...
                <v-col cols="5">
                    ...
                    <v-text-field class="mt-3" v-model="patient_vital_signs.temperature" type="number" suffix="°C"
                        outlined dense>
                    </v-text-field>
                </v-col>
                <v-col cols="5">
                    ...
                    <v-text-field class="mt-3" v-model="patient_vital_signs.sat" type="number" suffix="%" outlined
                        dense></v-text-field>
                </v-col>
            </v-row>
        </v-col>
                ...
                <v-col class="font-weight-bold text-center" cols="12" md="3">
                    <v-row>
                        <v-col cols="12">
                            ...
                            <v-text-field class="mt-3" v-model="patient_vital_signs.takes[index]['breathing_rate']"
                                type="number" suffix="rpm" outlined dense></v-text-field>
                        </v-col>
                    </v-row>
                </v-col>
                <v-col class="font-weight-bold text-center" cols="12" md="3">
                    <v-row>
                        <v-col cols="12">
                            ...
                            <v-text-field class="mt-3" v-model="patient_vital_signs.takes[index]['frc']" type="number"
                                suffix="lat x min" outlined dense></v-text-field>
                        </v-col>
                    </v-row>
                </v-col>
        </v-col>
        <v-col cols="12">
            ...
            <v-row class="d-flex align-center justify-center">
                <v-col class="font-weight-bold text-center" cols="12" md="4">
                    <v-row>
                        <v-col cols="5">
                            <v-text-field label="PAS" v-model="patient_vital_signs.takes[index][0]['pa_right_arm1']"
                                @input="getAverage(
                                                  [
                                                  ...
                                                  ], index, 'pa_right_arm1_average')" suffix="mmHg" outlined dense>
                            </v-text-field>
                        </v-col>
                        <v-col cols="2">/</v-col>
                        <v-col cols="5">
                            <v-text-field label="PAD" v-model="patient_vital_signs.takes[index][0]['pa_right_arm2']"
                                v-model="patient_vital_signs.takes[index][2]['pa_right_arm1']" @input="getAverage(
                                                  [
                                                  ...
                                                  ], index, 'pa_right_arm2_average')" suffix="mmHg" outlined dense>
                            </v-text-field>
                        </v-col>
                    </v-row>
                </v-col>
                <v-col class="font-weight-bold text-center" cols="12" md="4">
                    <v-row>
                        <v-col cols="5">
                            <v-text-field label="PAS" v-model="patient_vital_signs.takes[index][0]['pa_left_arm1']"
                                @input="getAverage(
                                                  [
                                                  ...
                                                  ], index, 'pa_left_arm1_average')" suffix="mmHg" outlined dense>
                            </v-text-field>
                        </v-col>
                        <v-col cols="2">/</v-col>
                        <v-col cols="5">
                            <v-text-field label="PAD" v-model="patient_vital_signs.takes[index][0]['pa_left_arm2']"
                                @input="getAverage(
                                                  [
                                                  ...
                                                  ], index, 'pa_left_arm2_average')" suffix="mmHg" outlined dense>
                            </v-text-field>
                        </v-col>
                    </v-row>
                </v-col>
            ...
            <v-row class="d-flex align-center mt-n-10 justify-center">
                <v-col class="font-weight-bold text-center" cols="12" md="4">
                    <v-row>
                        <v-col cols="5">
                            <v-text-field label="PAS" v-model="patient_vital_signs.takes[index][1]['pa_right_arm1']"
                                @input="getAverage(
                                                  [
                                                    patient_vital_signs.takes[index][0]['pa_right_arm1'],
                                                    patient_vital_signs.takes[index][1]['pa_right_arm1'],
                        ...
                        <v-col cols="2">/</v-col>
                        <v-col cols="5">
                            <v-text-field label="PAD" v-model="patient_vital_signs.takes[index][1]['pa_right_arm2']"
                                v-model="patient_vital_signs.takes[index][2]['pa_right_arm1']" @input="getAverage(
                                                  [
                                                    patient_vital_signs.takes[index][0]['pa_right_arm2'],
                                                    patient_vital_signs.takes[index][1]['pa_right_arm2'],
                ...
                <v-col class="font-weight-bold text-center" cols="12" md="4">
                    <v-row>
                        <v-col cols="5">
                            <v-text-field label="PAS" v-model="patient_vital_signs.takes[index][1]['pa_left_arm1']"
                                @input="getAverage(
                                                  [
                                                    patient_vital_signs.takes[index][0]['pa_left_arm1'],
                                                    patient_vital_signs.takes[index][1]['pa_left_arm1'],
                        ...
                        <v-col cols="2">/</v-col>
                        <v-col cols="5">
                            <v-text-field label="PAD" v-model="patient_vital_signs.takes[index][1]['pa_left_arm2']"
                                @input="getAverage(
                                                  [
                                                    patient_vital_signs.takes[index][0]['pa_left_arm2'],
                                                    patient_vital_signs.takes[index][1]['pa_left_arm2'],
            ...
            <v-row class="d-flex align-center pt-0 mt-0 justify-center">
                <v-col class="font-weight-bold text-center" cols="12" md="4">
                    <v-row>
                        <v-col cols="5">
                            <v-text-field label="PAS" v-model="patient_vital_signs.takes[index][2]['pa_right_arm1']"
                                @input="getAverage(
                                                  [
                                                    patient_vital_signs.takes[index][0]['pa_right_arm1'],
                                                    patient_vital_signs.takes[index][1]['pa_right_arm1'],
                        ...
                        <v-col cols="2">/</v-col>
                        <v-col cols="5">
                            <v-text-field label="PAD" v-model="patient_vital_signs.takes[index][2]['pa_right_arm2']"
                                v-model="patient_vital_signs.takes[index][2]['pa_right_arm1']" @input="getAverage(
                                                  [
                                                    patient_vital_signs.takes[index][0]['pa_right_arm2'],
                                                    patient_vital_signs.takes[index][1]['pa_right_arm2'],
                ...
                <v-col class="font-weight-bold text-center" cols="12" md="4">
                    <v-row>
                        <v-col cols="5">
                            <v-text-field label="PAS" v-model="patient_vital_signs.takes[index][2]['pa_left_arm1']"
                                @input="getAverage(
                                                  [
                                                    patient_vital_signs.takes[index][0]['pa_left_arm1'],
                                                    patient_vital_signs.takes[index][1]['pa_left_arm1'],
                        ...
                        <v-col cols="2">/</v-col>
                        <v-col cols="5">
                            <v-text-field label="PAD" v-model="patient_vital_signs.takes[index][2]['pa_left_arm2']"
                                @input="getAverage(
                                                  [
                                                    patient_vital_signs.takes[index][0]['pa_left_arm2'],
                                                    patient_vital_signs.takes[index][1]['pa_left_arm2'],
                ...
                <v-col class="font-weight-bold text-center" cols="12" md="4">
                    <v-row
                        ...
                        <v-col cols="5">
                            ...
                            <v-text-field label="Promedio PAS"
                                v-model="patient_vital_signs.takes[index]['pa_right_arm1_average']" suffix="mmHg"
                        ...
                        <v-col cols="5">
                            ...
                            <v-text-field label="Promedio PAD"
                                v-model="patient_vital_signs.takes[index]['pa_right_arm2_average']" suffix="mmHg"
                                outlined dense disabled></v-text-field>
                        </v-col>
                    </v-row>
                </v-col>
                <v-col class="font-weight-bold text-center" cols="12" md="4">
                    <v-row
                        ...
                        <v-col cols="5">
                            ...
                            <v-text-field label="Promedio PAS"
                                v-model="patient_vital_signs.takes[index]['pa_left_arm1_average']" suffix="mmHg"
                                outlined dense disabled></v-text-field>
                        </v-col>
                        <v-col cols="2">/</v-col>
                        <v-col cols="5">
                            ...
                            <v-text-field label="Promedio PAD"
                                v-model="patient_vital_signs.takes[index]['pa_left_arm2_average']" suffix="mmHg"
                                outlined dense disabled></v-text-field>
                        </v-col>
                    </v-row>
                </v-col>
