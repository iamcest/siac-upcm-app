        ...
        <v-col cols="12" class="pt-9" v-if="patient_risk_factors.selectedForm.calc_name == 'CrCI Cockgroft/Gault'">
          ...
          <v-form>
            <v-row class="px-6">
              ...
              <v-col cols="12" md="6">
                <label>Género</label>
                <v-select class="mt-3" v-model="patient_risk_factors.selectedForm.crci_cockgroft_gault_vars.vars.gender" :items="genders" item-text="name" item-value="gender" outlined required></v-select>
              </v-col>
              ...
              <v-col cols="12" md="4" offset-md="4">
                ...
                <v-text-field class="mt-3 result-box" :value="patient_risk_factors.selectedForm.crci_cockgroft_gault_vars.results" outlined readonly required ></v-text-field>
              </v-col>

              <v-col class="d-flex justify-center mt-n10" cols="12" md="4" offset-md="4">
                <v-btn class="secondary white--text" v-on:click="patient_risk_factors.selectedForm.crci_cockgroft_gault_vars.calc()">
                  Calcular
                </v-btn>
              </v-col>  
