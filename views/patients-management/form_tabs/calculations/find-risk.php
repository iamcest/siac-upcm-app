        ...
        <v-col cols="12" class="pt-8" v-if="patient_risk_factors.selectedForm.calc_name == 'FINDRISK'">
          ...
          <v-form>
            <v-row class="px-6"> 
              ...
              <v-col cols="12" md="6">
                <label>Género</label>
                <v-select class="mt-3" v-model="patient_risk_factors.selectedForm.obj.vars.gender" :items="genders" item-text="name" item-value="gender" :value="editedItem.gender" outlined required></v-select>
              </v-col>
                         
              <v-col cols="12" md="6">
                <label>Perímetro de la cintura</label>
                <v-text-field class="mt-3" v-model="patient_risk_factors.selectedForm.obj.vars.perimeter" hint="Ingrese la unidad en cm" suffix="cm" persistent-hint outlined required ></v-text-field>
              </v-col>
