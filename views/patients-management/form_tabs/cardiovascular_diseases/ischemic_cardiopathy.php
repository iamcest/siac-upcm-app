                    ...
                    <v-dialog ref="cd_ischemic_cardiopathy_sca_im_year_modal"
                        ...
                        <template #activator="{ on, attrs }">
                            <v-text-field :value="getOnlyYear(IM.year)" append-icon="mdi-calendar" readonly
                                ...
                                @click="patient_history.modals.ischemic_cardiopathy.current = index" outlined dense>
                                <template class="black-text" #prepend>
                        ...
                        <v-date-picker ref="cd_ischemic_cardiopathy_sca_im_datepicker" v-model="IM.year"
                            @input="$refs.cd_ischemic_cardiopathy_sca_im_year_modal[index].save(IM.year)" locale="es"
                            reactive no-title scrollable>
                        </v-date-picker>
                    </v-dialog>
                </v-col>
                <v-col cols="12">
                        ...
                        <template
                            ...
                            <v-col cols="12" lg="6">
                                <v-select
                                    ...
                                    :items="patient_history.options.ischemic_cardiopathy.general_select" outlined dense>
                                    <template class="black-text" #prepend>
                        ...
                        <template
                            ...
                            <v-col cols="12" lg="6">
                                <v-dialog ref="cd_ischemic_cardiopathy_percutaneous_year_modal"
                                    v-model="ph_cd_ischemic_cardiopathy_percutaneous_year_modal" width="290px">
                                    <template #activator="{ on, attrs }">
                                        <v-text-field
                                    ...
                                    <v-date-picker ref="cd_ischemic_cardiopathy_percutaneous_year_datepicker"
