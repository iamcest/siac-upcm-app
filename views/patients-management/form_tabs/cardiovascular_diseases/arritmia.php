<v-row>
    ...
    <v-col class="factor-risk-container" cols="6">
        <v-row>
            <v-col cols="12">
                <v-select v-model="patient_history.form.history_content.cardiovascular_diseases.arritmia.type"
            ...
            <template v-if="patient_history.form.history_content.cardiovascular_diseases.arritmia.type == 'FA'">
                ...
                <v-col cols="12" lg="6">
                    <v-select v-model="patient_history.form.history_content.cardiovascular_diseases.arritmia.ablation"
    ...
    <v-col cols="12" lg="6">
        <v-select v-model="patient_history.form.history_content.cardiovascular_diseases.arritmia.cdi_holder"
            :items="patient_history.select" outlined dense>
            <template class="black-text" #prepend>
    ...
    <v-col cols="12" lg="6" v-if="patient_history.form.history_content.cardiovascular_diseases.arritmia.cdi_holder">
        <v-text-field v-model="patient_history.form.history_content.cardiovascular_diseases.arritmia.cdi_age" outlined
            dense>
            <template class="black-text" #prepend>
                <span class="font-weight-bold">Año:</span>
            </template>
...
<v-col class="factor-risk-container" cols="6">
    <v-row>
        <v-col cols="6">
            <v-select v-model="patient_history.form.history_content.cardiovascular_diseases.arritmia.treatment"
                :items="patient_history.select" outlined dense>
                <template class="black-text" #prepend>
        ...
        <v-col cols="6" v-if="patient_history.form.history_content.cardiovascular_diseases.arritmia.treatment"
            ...
            <v-text-field v-model="patient_history.form.history_content.cardiovascular_diseases.arritmia.treatments[i]" outlined dense>
