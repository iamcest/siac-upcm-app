                              <v-row class="full-width">
                                  <v-col cols="12" sm="4">
                                      ...
                                      <v-text-field class="mt-3 append-20"
                                          v-model="patient_anthropometry.editedItem.weight" outlined>
                                          <template #append>
                                              <v-select v-model="patient_anthropometry.editedItem.weight_suffix"
                                                  class="p-0 m-0 mt-n1 mb-n4" :items="['kg', 'lb']" dense></v-select>
                                          </template>
                                      </v-text-field>
                                  </v-col>
                                  <v-col cols="12" sm="4">
                                      ...
                                      <v-text-field class="mt-3 append-20"
                                          v-model="patient_anthropometry.editedItem.height" outlined>
                                          <template #append>
                                              <v-select v-model="patient_anthropometry.editedItem.height_suffix"
                                                  class="p-0 m-0 mt-n1 mb-n4" :items="['cm', 'in']" dense></v-select>
                                          </template>
                                      </v-text-field>
                                  </v-col>
                                  <v-col cols="12" sm="4">
                                      ...
                                      <v-text-field class="mt-3 append-20"
                                          v-model="patient_anthropometry.editedItem.abdominal_waist" outlined>
                                          <template #append>
                                              <v-select
                                                  v-model="patient_anthropometry.editedItem.abdominal_waist_suffix"
                                                  class="p-0 m-0 mt-n1 mb-n4" :items="['cm', 'in']" dense></v-select>
                                          </template>
                                      </v-text-field>
                                  </v-col>
                                  <v-col cols="12" v-if="parseInt(patient_anthropometry.editedItem.weight) != 0 || parseInt(patient_anthropometry.editedItem.height) != 0 ">
