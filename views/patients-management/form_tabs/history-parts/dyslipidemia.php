<v-col cols="12">
    <v-row class="d-flex justify-start align-center">
        <v-col class="mt-6" cols="6" md="4" lg="3">
            <v-select v-model="patient_history.form.history_content.diseases.dyslipidemia.active"
        ...
        <template v-if="patient_history.form.history_content.diseases.dyslipidemia.active">
            <v-col cols="6" md="4" lg="3">
                ...
                <v-select v-model="patient_history.form.history_content.diseases.dyslipidemia.controlled"
                    :items="patient_history.select" item-text='text' item-value='value'
                    @change="diagnosticDateCheck(patient_history.form.history_content.diseases.dyslipidemia)" outlined
                    dense>
                </v-select>
            </v-col>
            <v-col cols="6" md="4" lg="3">
                <label class="black--text font-weight-bold">Diagnóstico previo:</label>
                <v-select v-model="patient_history.form.history_content.diseases.dyslipidemia.detected_previously"
                    :items="patient_history.select" item-text='text' item-value='value'
                    @change="diagnosticDateCheck(patient_history.form.history_content.diseases.dyslipidemia)" outlined
                    dense>
                </v-select>
            ...
            <v-col cols="6" md="4" lg="3"
                v-if="patient_history.form.history_content.diseases.dyslipidemia.detected_previously">
                <label class="black--text font-weight-bold">Tiempo de diagnóstico:</label>
                <v-select v-model="patient_history.form.history_content.diseases.dyslipidemia.diagnostic_date"
