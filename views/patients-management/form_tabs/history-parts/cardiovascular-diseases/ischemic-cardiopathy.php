    ...
    <v-card class="px-2 py-10" width="100%">
        <v-row>
            ...
            <v-col cols="12" md="6" lg="4" offset-md="3" offset-lg="4">
                <label class="font-weight-bold black--text">Ha padecido esta enfermedad:</label>
                <v-select
                    v-model="patient_history.form.history_content.cardiovascular_diseases.ischemic_cardiopathy.active"
                    :items="patient_history.select" outlined dense></v-select>
            </v-col>
            <template v-if="patient_history.form.history_content.cardiovascular_diseases.ischemic_cardiopathy.active">
                <v-col cols="12" md="6">
                    <v-card class="px-4" outlined>
                        ...
                        <v-row
                            v-for="(IM, i) in patient_history.form.history_content.cardiovascular_diseases.ischemic_cardiopathy.sca.im">
                            <template
                                v-if="patient_history.form.history_content.cardiovascular_diseases.ischemic_cardiopathy.sca.active">
                                <v-col class="mt-n10 d-flex justify-end" cols="12" v-if="i != 0">
                                    <v-btn color="error" text
                                        @click="patient_history.form.history_content.cardiovascular_diseases.ischemic_cardiopathy.sca.im.splice(i, 1)"
                                        right>
                                ...
                                <v-col cols="12" lg="6">
                                    <v-dialog ref="cd_ischemic_cardiopathy_sca_im_year_modal"
                                        ...
                                        <v-date-picker ref="cd_ischemic_cardiopathy_sca_im_datepicker" v-model="IM.year"
                                            @input="$refs.cd_ischemic_cardiopathy_sca_im_year_modal[i].save(IM.year)"
                        ...
                        <v-col cols="12">
                            <v-btn color="secondary"
                                v-if="patient_history.form.history_content.cardiovascular_diseases.ischemic_cardiopathy.sca.active"
                                @click="patient_history.form.history_content.cardiovascular_diseases.ischemic_cardiopathy.sca.im.push(
                                {
                                    q: 1,
                                    no_q: 1,
                                    year: '',
                                        ...
                                        <template
                                            ...
                                            <v-col cols="12" lg="6">
                                                <v-dialog ref="ph_cd_ischemic_cardiopathy_surgery_year"
                                                    v-model="ph_cd_ischemic_cardiopathy_surgery_year_modal"
                                                    width="290px">
                                                    <template #activator="{ on, attrs }">
                                                        <v-text-field
