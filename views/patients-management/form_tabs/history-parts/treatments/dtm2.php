            ...
            <v-row>
                ...
                <template v-if="patient_history.form.history_content.diseases.dtm2.metformin.active">
                    ...
                    <v-col class="mt-n4" cols="12"
                        ...
                        <v-select
                            v-model="patient_history.form.history_content.diseases.dtm2.metformin.secondary_effects"
                            class="black-text mt-3"
                            :items="patient_history.form.history_content.diseases.dtm2.secondary_effects.metformin"
                            outlined dense>
            ...
            <v-row>
                <v-col cols="12">
                    ...
                    <v-select v-model="patient_history.form.history_content.diseases.dtm2.a_insulin.treatment"
                        :items="patient_history.form.history_content.diseases.dtm2.treatments_list.a_insulin"
                        class="mt-3" outlined dense>
                        <template #prepend-item>
                            <v-list-item>
                                <v-list-item-content>
                ...
                <v-col class="mt-n4" cols="12">
                    <v-text-field v-model="patient_history.form.history_content.diseases.dtm2.a_insulin.dosis"
                ...
                <v-col class="mt-n4" cols="12">
                    <label class="black--text font-weight-bold">Reacciones adversas:</label>
                    <v-select
                        v-model="patient_history.form.history_content.diseases.dtm2.a_insulin.has_secondary_effects"
                        class="black-text mt-3" :items="patient_history.select" outlined dense></v-select>
                </v-col>
                <v-col class="mt-n4" cols="12"
        ...
        <v-col cols="6" md="2">
            <v-row>
                ...
                <v-col class="mt-n4" cols="12"
                    ...
                    <label class="black--text font-weight-bold">Tipo de reacción:</label>
                    <v-select
                        v-model="patient_history.form.history_content.diseases.dtm2.sulfonylureas.secondary_effects"
                        class="black-text mt-3"
                        :items="patient_history.form.history_content.diseases.dtm2.secondary_effects.sulfonylureas"
                        outlined dense>
                        <template #prepend-item>
                            <v-list-item>
                                <v-list-item-content>
            ...
            <v-row>
                <v-col cols="12">
                    ...
                    <v-select v-model="patient_history.form.history_content.diseases.dtm2.glinidas.treatment"
                        :items="patient_history.form.history_content.diseases.dtm2.treatments_list.glinidas"
                        class="mt-3" outlined dense>
                        <template #prepend-item>
                            <v-list-item>
                                <v-list-item-content>
                ...
                <v-col class="mt-n4" cols="12">
                    <v-text-field v-model="patient_history.form.history_content.diseases.dtm2.glinidas.dosis"
                        class="mt-3" outlined dense>
                        <template class="black-text" #prepend>
                            <span class="font-weight-bold">Dosis diarias:</span>
                        </template>
                ...
                <v-col class="mt-n4" cols="12">
                    <label class="black--text font-weight-bold">Reacciones adversas:</label>
                    <v-select
                        v-model="patient_history.form.history_content.diseases.dtm2.glinidas.has_secondary_effects"
                        class="black-text mt-3" :items="patient_history.select" outlined dense></v-select>
                </v-col>
                <v-col class="mt-n4" cols="12"
        ...
        <v-col cols="6" md="2">
            <v-row>
                ...
                <v-col class="mt-n4" cols="12"
                    ...
                    <label class="black--text font-weight-bold">Tipo de reacción:</label>
                    <v-select
                        v-model="patient_history.form.history_content.diseases.dtm2.pioglitazona.secondary_effects"
                        class="black-text mt-3"
                        :items="patient_history.form.history_content.diseases.dtm2.secondary_effects.pioglitazona"
                        outlined dense>
                        <template #prepend-item>
                            <v-list-item>
                                <v-list-item-content>
            ...
            <v-row>
                ...
                <v-col class="mt-n4" cols="12">
                    <v-text-field class="mt-3"
                        v-model="patient_history.form.history_content.diseases.dtm2.inh_dpp.dosis" class="black-text"
                        outlined dense>
                        <template #prepend>
                            <span class="font-weight-bold">Dosis diarias:</span>
                        </template>
            ...
            <v-row>
                <v-col cols="12">
                    ...
                    <v-select v-model="patient_history.form.history_content.diseases.dtm2.gl.treatment"
                        :items="patient_history.form.history_content.diseases.dtm2.treatments_list.gl" class="mt-3"
                        outlined dense>
                        <template #prepend-item>
                            <v-list-item>
                                <v-list-item-content>
                ...
                <v-col class="mt-n4" cols="12">
                    <label class="black--text font-weight-bold">Frecuencia:</label>
                    <v-select :items="patient_history.options.treatment_frecuency"
                        v-model="patient_history.form.history_content.diseases.dtm2.gl.frecuency"
                        class="black-text mt-3" outlined dense></v-select>
                </v-col>
                <v-col class="mt-n4" cols="12">
                    <label class="black--text font-weight-bold">Reacciones adversas:</label>
                ...
                <v-col class="mt-n4" cols="12"
                    ...
                    <v-select v-model="patient_history.form.history_content.diseases.dtm2.gl.secondary_effects"
                        class="black-text mt-3"
                        :items=" patient_history.form.history_content.diseases.dtm2.secondary_effects.gl" outlined
                        dense>
                        <template #prepend-item>
                            <v-list-item>
                                <v-list-item-content>
                ...
                <v-col cols="12" md="4" lg="3">
                    ...
                    <v-col cols="12" v-if="patient_history.form.history_content.diseases.dtm2.fdc.active">
                        ...
                        <v-select v-model="patient_history.form.history_content.diseases.dtm2.fdc.selected"
                            :items="patient_history.form.history_content.diseases.dtm2.treatments_list.fdc"
