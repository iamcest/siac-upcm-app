<v-row>
    <v-col cols="12">
        ...
        <v-checkbox label="Acceso" v-model="editedItem.meta.patient_management_access.access" :true-value="1" :false-value="0"></v-checkbox>
    </v-col>
    <v-col cols="12" md="6" v-for="section in editedItem.meta.patient_management_access.sections" v-if="editedItem.meta.patient_management_access.access">
        <h6 class="text-h6">
            {{ section.name }}
        </h6>
        <v-row>
