...
e.patient_appointments.select=!1}))},getDoctorFullName(e){var t=this.patient_appointments,a=t.doctors.filter(t=>t.user_id==e);return a[0].full_name},getRiskFactorData(e){var t=this.patient_risk_factors.risk_factors_list.items,a=t.filter(t=>t.name==e);return a},filterExamsByName(e){var t=this.patient_laboratory_exams.exams.find(t=>t.name==e);return t},showExamInfo(e){switch(this.showExamResults(e),e.name){case"Colesterol LDL":var t=this,a=api_url+"medical-exams/get",i={exam_id:t.filterExamsByName("Colesterol Total").exam_id,patient_id:t.editedItem.patient_id},r={exam_id:t.filterExamsByName("Colesterol HDL").exam_id,patient_id:t.editedItem.patient_id},n={exam_id:t.filterExamsByName("Triglicéridos").exam_id,patient_id:t.editedItem.patient_id};t.$http.post(a,i).then(e=>{t.patient_laboratory_exams.formulas.cholesterol_ldl.vars.total_cholesterol=e.body.length>0?e.body[e.body.length-1].results:0},e=>{}),t.$http.post(a,r).then(e=>{t.patient_laboratory_exams.formulas.cholesterol_ldl.vars.c_HDL=e.body.length>0?e.body[e.body.length-1].results:0},e=>{}),t.$http.post(a,n).then(e=>{t.patient_laboratory_exams.formulas.cholesterol_ldl.vars.triglyceride_level=e.body.length>0?e.body[e.body.length-1].results:0},e=>{});break;case"Colesterol No HDL":t=this,a=api_url+"medical-exams/get",i={exam_id:t.filterExamsByName("Colesterol Total").exam_id,patient_id:t.editedItem.patient_id};var s={exam_id:t.filterExamsByName("Colesterol No HDL").exam_id,patient_id:t.editedItem.patient_id};t.$http.post(a,i).then(e=>{t.patient_laboratory_exams.formulas.cholesterol_no_hdl.vars.total_cholesterol=e.body.length>0?e.body[e.body.length-1].results:0},e=>{}),t.$http.post(a,s).then(e=>{t.patient_laboratory_exams.formulas.cholesterol_no_hdl.vars.c_HDL=e.body.length>0?e.body[e.body.length-1].results:0},e=>{})}},showExamResults(e){var t=this,a=t.patient_laboratory_exams;a.laboratory_exam=!0,a.selectedExam=e;var i=api_url+"medical-exams/get",r={exam_id:e.exam_id,patient_id:this.editedItem.patient_id};t.$http.post(i,r).then(e=>{a.exam_results=e.body},e=>{})},showComparisonExamResults(e){var t=this,a=t.comparison.laboratory_exams;a.loading=!0,a.selectedExam=e,a.examsListed=!0,a.current_patient=[],a.patient_to_compare=[];var i=api_url+"medical-exams/get/comparison",r={exam_id:e.exam_id,current_patient_id:t.comparison.patient_selected.patient_id,patient_to_compare_id:t.comparison.patient_to_compare.patient_id};t.$http.post(i,r).then(e=>{if(e.body.hasOwnProperty("current_patient_items")&&e.body.hasOwnProperty("patient_to_compare_items")){var t=e.body.current_patient_items.length>1?e.body.current_patient_items[e.body.current_patient_items.length-1]:e.body.current_patient_items[0];a.current_patient.push(t);var i=e.body.patient_to_compare_items.length>1?e.body.patient_to_compare_items[e.body.patient_to_compare_items.length-1]:e.body.patient_to_compare_items[0];a.patient_to_compare.push(i)}a.loading=!1},e=>{a.loading=!1})},showFileExamResults(e){var t=this,a=t.patient_laboratory_exams;a.laboratory_exam=!0,a.selectedExam=e;var i=api_url+"medical-exams/get-exam-files",r={exam_id:e.exam_id,patient_id:this.editedItem.patient_id};t.$http.post(i,r).then(e=>{a.exam_files=e.body},e=>{})},assignGeneralVars(){var e=this,t=e.patient_risk_factors;""!=t.selectedForm.calc_name&&e.getCurrentFactorRisk(),t.detail_table_rf_selected=Object.assign({},t.selectedForm),e.setAnthropometryVars(),t.selectedForm.obj.vars.age=moment(e.editedItem.birthdate,"YYYY-MM-DD").fromNow().split(" ")[1],t.selectedForm.obj.vars.gender=e.editedItem.gender},getBMI(e,t,a,i){if(0!=t&&0!=e){e="lb"==a?e/2.205:e,t="in"==i?2.54*t:t,t=Math.pow(t/100,2);var r=Math.round(10*e/t)/10;return NaN!=typeof r&&(r+=" kg/m2"),r}return""},getCS(e,t,a,i){if(0!=t&&0!=e){e="lb"==a?e/2.205:e,t="in"==i?2.54*t:t;var r=3600,n=Math.pow(t*e/r,.5),s=Math.round(100*n)/100;return NaN!=typeof s&&(s+=" m2"),s}return""},getVitalSignalsAverage(e,t){var a=0;if(sitting=e.sitting,lying_down=e.lying_down,standing=e.standing,"left"==t){0==parseInt(sitting.pa_left_arm1)&&0==parseInt(sitting.pa_left_arm2)||a++,0==parseInt(lying_down.pa_left_arm1)&&0==parseInt(lying_down.pa_left_arm2)||a++,0==parseInt(standing.pa_left_arm1)&&0==parseInt(standing.pa_left_arm2)||a++;var i=Math.round((parseInt(sitting.pa_left_arm1)+parseInt(lying_down.pa_left_arm1)+parseInt(standing.pa_left_arm1))/a),r=Math.round((parseInt(sitting.pa_left_arm2)+parseInt(lying_down.pa_left_arm2)+parseInt(standing.pa_left_arm2))/a),n=i-r,s=Math.round(r- -(i-r)/a);return{pulse_pressure:n,pam:s}}if("right"==t){0==parseInt(sitting.pa_right_arm1)&&0==parseInt(sitting.pa_right_arm2)||a++,0==parseInt(lying_down.pa_right_arm1)&&0==parseInt(lying_down.pa_right_arm2)||a++,0==parseInt(standing.pa_right_arm1)&&0==parseInt(standing.pa_right_arm2)||a++;i=Math.round((parseInt(sitting.pa_right_arm1)+parseInt(lying_down.pa_right_arm1)+parseInt(standing.pa_right_arm1))/a),r=Math.round((parseInt(sitting.pa_right_arm2)+parseInt(lying_down.pa_right_arm2)+parseInt(standing.pa_right_arm2))/a),n=i-r,s=Math.round(r- -(i-r)/a);return{pulse_pressure:n,pam:s}}},getAverage(e,t,a){var i=this,r=0,n=0;return e.forEach(e=>{if(0==parseInt(e)||null==typeof e||""==e)return!1;r++;var t=parseInt(e);n+=t}),r>0&&(n=Math.round(n/r)),i.patient_vital_signs.takes[t][a]=n,n},getFRCAverage(e){var t=0,a=0;return e.forEach(e=>{if(0==parseInt(e)||null==typeof e||""==e)return!1;t++;var i=parseInt(e);a+=i}),t>0&&(a=Math.round(a/t)),a},getSDverage(e){var t=0,a=0;return e.forEach(e=>{if(0==parseInt(e)||null==typeof e||""==e)return!1;t++;var i=parseInt(e);a+=i}),t>0&&(a=Math.round(a/t)),a},calcCholesterolLDL(){var e=this;if(!e.$refs.ple_formulas_cholesterol_ldl.validate())return!1;var t=e.patient_laboratory_exams.formulas.cholesterol_ldl;e.patient_laboratory_exams.formulas.cholesterol_ldl.results=parseInt(t.vars.total_cholesterol)-parseInt(t.vars.c_HDL),e.patient_laboratory_exams.editedItem.results=parseInt(t.vars.total_cholesterol)-parseInt(t.vars.c_HDL)-parseInt(t.vars.triglyceride_level/5)},calcCholesterolNoHDL(){var e=this,t=e.patient_laboratory_exams.formulas.cholesterol_no_hdl;e.patient_laboratory_exams.formulas.cholesterol_ldl.results=parseInt(t.vars.total_cholesterol)-parseInt(t.vars.c_HDL),e.patient_laboratory_exams.editedItem.results=parseInt(t.vars.total_cholesterol)-parseInt(t.vars.c_HDL)},calcQTC(){var e=this,t=e.patient_electro_cardiogram.content,a=t.qt,i=t.fc;t.rr=60/parseInt(i),t.rr=parseFloat(t.rr),t.qtrau=656/(1+parseInt(i)/100),t.qtrau=parseInt(t.qtrau),t.qtbaz=parseInt(a)/Math.sqrt(parseFloat(t.rr)),t.qtbaz=parseInt(t.qtbaz),t.qtfra=parseInt(a)+.154*(1-parseFloat(t.rr)),t.qtfra=parseInt(t.qtfra),t.qtfri=parseInt(a)/Math.pow(parseFloat(t.rr),1/3),t.qtfri=parseInt(t.qtfri),t.qtcal=parseInt(a)/Math.pow(parseFloat(t.rr)*parseFloat(t.rr),.2),t.qtcal=parseInt(t.qtcal)},calcAAI(){var e=this,t=e.patient_physical_exam.content.calc.aai,a=t.vars.tpi,i=t.vars.pi,r=t.vars.tpd,n=t.vars.pd,s=t.vars.hi,o=t.vars.hd,p=t.vars.pai=0,d=t.vars.pad=0,c=t.vars.pah=0;a>=i?p=a:a<i?p=i:a>0?p=a:i>0&&(p=i),r>=n?d=r:r<n?d=n:r>0?d=r:n>0&&(d=n),s>=o?c=s:s<o?c=o:s>0?c=s:o>0&&(c=o);var _=t.itbi=(p/c).toFixed(2),m=t.itbd=(d/c).toFixed(2);e.patient_physical_exam.content.aai.range=_+" - "+m,t.itbi_result=_<=.4?"Cuando el valor es menor o igual 0,4 se considera estenosis grave.":_<.9?"Cuando el valor es mayor a 0,4 y menor de 0,9 se considera estenosis leve/moderada.":_<=1.2?"Los valores situados entre 0,9 y 1,2 son considerados normales.":_>1.2?"Cuando el valor es mayor a 1,20 pueden existir calcificaciones arteriales.":"",t.itbd_result=m<=.4?"Cuando el valor es menor o igual 0,4 se considera estenosis grave.":m<.9?"Cuando el valor es mayor a 0,4 y menor de 0,9 se considera estenosis leve/moderada.":m<=1.2?"Los valores situados entre 0,9 y 1,2 son considerados normales.":m>1.2?"Cuando el valor es mayor a 1,20 pueden existir calcificaciones arteriales.":""},fagerstromTest(){var e=this,t=e.patient_life_style.calc.fagerstrom,a=t.vars,i=a.input1+a.input2+a.input3+a.input4+a.input5+a.input6;return t.result=i,i},getFagerStromScoreDescription(e){var t=this,a=e?parseInt(t.patient_life_style.calc.fagerstrom.result):parseInt(t.patient_life_style.editedItem.smoking.fagerstrom_test),i="";return i=""==a?"":a>=0&&a<=2?"Dependencia MUY BAJA":a>=3&&a<=4?"Dependencia BAJA":5==a?"Dependencia MODERADA":a>=6&&a<=7?"Dependencia ALTA":a>=8&&a<=10?"Dependencia ALTA":"",i},pregnancyAlert(e){var t=this,a=e,i="",r=a.find(e=>e.includes("BRA")||e.includes("IECAS"));return i=null!=r&&r.length>0&&"F"==t.editedItem.gender,i},gfrCkdEpiFx(){var e=this,t=e.editedItem,a=t.gender,i=e.patient_laboratory_exams.formulas.filt_glom,r="M"==a?1:1.018,n="M"==a?-.411:-.329,s="M"==a?.9:.7,o=i.vars.serum_creatinine,p=i.vars.race,d=parseFloat(moment().diff(t.birthdate,"years")),c=141*Math.pow(Math.min(o/s,1),n)*Math.pow(Math.max(o/s,1),-1.209)*Math.pow(.993,d)*r*p;return e.patient_laboratory_exams.formulas.filt_glom.results=c.toFixed(2),e.patient_laboratory_exams.editedItem.results=c.toFixed(2),c.toFixed(2)},gfrRrmdFx(){var e=this,t=e.editedItem,a=t.gender,i=e.patient_laboratory_exams.formulas.egfr_mdr_ckdepi,r="M"==a?1:.742,n=i.vars.serum_creatinine,s=i.vars.race,o=parseFloat(moment().diff(t.birthdate,"years"));Math.pow(n,-1.154),Math.pow(o,-.203);var p=175*Math.pow(n,-1.154)*Math.pow(o,-.203)*r*s;return e.patient_laboratory_exams.formulas.egfr_mdr_ckdepi.results=p.toFixed(2),e.patient_laboratory_exams.editedItem.results=p.toFixed(2),p.toFixed(2)},assignGFRVars(e){var t=this.patient_laboratory_exams.formulas,a=this.patient_laboratory_exams.formulas.egfr_mdr_ckdepi.vars;"CKD-EPI"==e&&(t.filt_glom.vars.serum_creatinine=a.serum_creatinine,t.filt_glom.vars.race=1.21==a.race?1.159:1)},prevImage(e){const t=e.target.files[0],a=new FileReader;a.readAsDataURL(t),a.onload=(e=>{this.editedItem.avatar=t,this.previewImage=e.target.result,this.upload_button=!0})},uploadImage(e){var t=this;let a=new FormData;var i=api_url+"patients/update-avatar";t.image_loading=!0,t.image_loading=!0,a.append("patient_id",t.editedItem.patient_id),a.append("avatar",t.editedItem.avatar),t.$http.post(i,a).then(e=>{t.image_loading=!1,"success"==e.body.status&&(t.upload_button=!1,t.editedItem.avatar=e.body.data.avatar),activateAlert(e.body.message,e.body.status)},e=>{})},diagnosticDateCheck(e){if(!e.detected_previously){if("Menos de un año"==e.diagnostic_date||"Entre 1 y 2 años"==e.diagnostic_date||"3 a 4 años"==e.diagnostic_date||"4 a 5 años"==e.diagnostic_date||"Más de 5 años"==e.diagnostic_date||"Más de 10 años"==e.diagnostic_date)return e.diagnostic_date=moment().format("YYYY[-]MM[-]DD"),!0;e.diagnostic_date=""==e.diagnostic_date?moment().format("YYYY[-]MM[-]DD"):e.diagnostic_date}},fromNow:e=>moment(e).format("LL"),getCurrentDate:e=>moment().format("YYYY-MM-DD"),addItemToArray(e,t,a=Boolean){""==e&&null==typeof e||(a?t.unshift(e):t.push(e))},addObjectToArray(e,t){""==e&&null==typeof e||t.push({name:e,group:"Group 4"})},getClinicExamsActive(e){var t=e.filter((e,t)=>parseInt(e.value));return t},getTimeDiff:e=>moment().diff(e,"years"),getOnlyYear:e=>""==e?"":moment(e).format("YYYY"),displayOnlyYear:e=>e.substring(0,4),resetPatientInformation(){this.patient_appointments.appointments=[]},searchFRTreatment(e){var t=this,a=t.patient_risk_factors;if(a.rf.hasOwnProperty("created_at")&&a.risk_factors_diagnostics.length>1){var i=a.risk_factors_diagnostics.length,r=a.rf.hasOwnProperty("created_at")?i-2:i-1,n=a.risk_factors_diagnostics[r].risk_factors.find(t=>t.name==e);return void 0!==n&&"Sí"==n.diagnostic&&"Sí"==n.has_treatment?n.comment:""}return""},hasPreviousFRTreatment(e){var t=this,a=t.patient_risk_factors;if(!t.patient_appointments.previous_appointment.hasOwnProperty("appointment_id"))return!1;if(a.risk_factors_diagnostics.length>1){var i=a.risk_factors_diagnostics.length,r=a.rf.hasOwnProperty("created_at")?i-2:i-1,n=a.risk_factors_diagnostics[r].risk_factors.find(t=>t.name==e);return void 0!==n&&"Sí"==n.diagnostic&&"Sí"==n.has_treatment}},previousFRTreatmentDescription(e,t,a=!1){var i=this,r=i.patient_risk_factors;if(r.rf.hasOwnProperty("created_at")&&r.risk_factors_diagnostics.length>1){var n=r.risk_factors_diagnostics.length,s=r.risk_factors_diagnostics[n-2].risk_factors.find(t=>t.name==e);return void 0!==s&&"Sí"==s.diagnostic&&"Sí"==s.has_treatment&&s.comment!=t&&""!=t?a?"Previo: "+s.comment:"Tratamiento cambiado de "+s.comment+" a "+t:""}n=r.risk_factors_diagnostics.length;return void 0!==r.risk_factors_diagnostics[n-1]?(s=r.risk_factors_diagnostics[n-1].risk_factors.find(t=>t.name==e),void 0!==s&&"Sí"==s.diagnostic&&"Sí"==s.has_treatment&&s.comment!=t&&""!=t?a?"Previo: "+s.comment:"Tratamiento cambiado de "+s.comment+" a "+t:""):""},getPercentDifference(e,t,a=!1){var i=this,r=i.patient_appointments;switch(t=void 0===t?{}:t,e){case"anthropometry":if(a){var n=i.comparison.anthropometry;if(n.current_patient.hasOwnProperty("patient_id")&&n.patient_to_compare.hasOwnProperty("patient_id")){var s=t.patient_to_compare?n.patient_to_compare:n.current_patient,o=t.patient_to_compare?n.current_patient:n.patient_to_compare,p=parseInt(s.abdominal_waist),d=parseInt(s.height),c=parseInt(s.weight),_=parseFloat(i.getBMI(c,d,s.weight_suffix,s.height_suffix).replace(" kg/m2","")),m=parseFloat(i.getCS(c,d,s.weight_suffix,s.height_suffix).replace(" m2","")),l=parseInt(o.abdominal_waist),u=parseInt(o.height),h=parseInt(o.weight),g=parseFloat(i.getBMI(h,u,o.weight_suffix,o.height_suffix).replace(" kg/m2","")),f=parseFloat(i.getCS(h,u,o.weight_suffix,o.height_suffix).replace(" m2","")),y=c-h,v=d-u,b=p-l,x=_-g,I=m-f,k={numeric:y,percent:y/(-1==Math.sign(y)?c:h)*100},w={numeric:v,percent:v/(-1==Math.sign(v)?d:u)*100},A={numeric:b,percent:b/(-1==Math.sign(b)?p:l)*100},O={numeric:x,percent:x/(-1==Math.sign(x)?_:g)*100},D={numeric:I,percent:I/(-1==Math.sign(I)?m:f)*100};return{weight:k,height:w,abdominal_waist:A,bmi:O,cs:D}}return{}}n=i.patient_anthropometry;var F={weight:0,height:0,abdominal_waist:0,bmi:0,cs:0};if(n.history.length>1){var E=void 0!==t&&t.hasOwnProperty("anthropometry")?t.anthropometry:n.editedItem,M=r.appointments.indexOf(r.appointments.find(e=>e.appointment_id==E.appointment_id)),P=r.appointments[M-1];if(null==P)return F;var S=n.history.find(e=>e.appointment_id==P.appointment_id),N=n.history.indexOf(E);if(S=null==S?n.history[N-1]:S,void 0!==S&&S.hasOwnProperty("appointment_id")){t.hasOwnProperty("anthropometry");p=parseInt(E.abdominal_waist),d=parseInt(E.height),c=parseInt(E.weight),_=parseFloat(i.getBMI(c,d,n.editedItem.weight_suffix,n.editedItem.height_suffix).replace(" kg/m2","")),m=parseFloat(i.getCS(c,d,n.editedItem.weight_suffix,n.editedItem.height_suffix).replace(" m2","")),l=parseInt(S.abdominal_waist),u=parseInt(S.height),h=parseInt(S.weight),g=parseFloat(i.getBMI(h,u,S.weight_suffix,S.height_suffix).replace(" kg/m2","")),f=parseFloat(i.getCS(h,u,S.weight_suffix,S.height_suffix).replace(" m2","")),k={numeric:c-h,percent:(c-h)/h*100},w={numeric:d-u,percent:(d-u)/u*100},A={numeric:p-l,percent:(p-l)/l*100},O={numeric:_-g,percent:(_-g)/g*100},D={numeric:m-f,percent:(m-f)/f*100};return{weight:k,height:w,abdominal_waist:A,bmi:O,cs:D}}return F}return F;case"vital-signals":if(a){n=i.comparison.vital_signs;if(n.current_patient.hasOwnProperty("patient_id")&&n.patient_to_compare.hasOwnProperty("patient_id")){s=t.patient_to_compare?n.patient_to_compare:n.current_patient,o=t.patient_to_compare?n.current_patient:n.patient_to_compare;var z=parseInt(s.sat),q=parseInt(s.sat),C=parseInt(o.lying_down.temperature),Y=parseInt(o.lying_down.sat),T={numeric:z-C,percent:(z-C)/C*100},R={numeric:q-Y,percent:(q-Y)/Y*100};if(X={},t.hasOwnProperty("index")){var $=s.takes[t.index],j=o.takes[t.index],L=parseInt($.breathing_rate),H=parseInt($.frc),B=parseInt(j.breathing_rate),G=parseInt(j.frc),J={};if(t.hasOwnProperty("arm")){var V=parseInt($[t.arm]),Q=parseInt(j[t.arm]);J={numeric:V-Q,percent:(V-Q)/Q*100}}var U={numeric:L-B,percent:(L-B)/B*100},K={numeric:H-G,percent:(H-G)/G*100};X={br:U,frc:K,arm:J}}return{temperature:T,sat:R,take:X}}return{}}n=i.patient_vital_signs;var X={br:{numeric:0,percent:0},frc:{numeric:0,percent:0},arm:{numeric:0,percent:0}},Z={pam:{left:{numeric:0,percent:0},right:{numeric:0,percent:0}},pulse_pressure:{left:{numeric:0,percent:0},right:{numeric:0,percent:0}},br:{numeric:0,percent:0},frc:{numeric:0,percent:0}};if(n.records.length>0){var W=t.hasOwnProperty("vital_signals")?t.vital_signals:{appointment_id:n.appointment_id,takes:n.takes},ee=void 0===W.appointment_id?null:n.records.indexOf(n.records.find(e=>e.appointment_id==W.appointment_id)),te=null!=ee?n.records[ee-1]:n.records[n.records.length-1];if(void 0!==te&&W.appointment_id!=te.appointment_id){z=void 0===W.temperature?parseInt(W.temperature):parseInt(W.lying_down.temperature),q=void 0===W.sat?parseInt(W.sat):parseInt(W.lying_down.sat),C=parseInt(te.lying_down.temperature),Y=parseInt(te.lying_down.sat),T={numeric:z-C,percent:(z-C)/C*100},R={numeric:q-Y,percent:(q-Y)/Y*100};if(t.hasOwnProperty("method")&&"average"==t.method){var ae=i.getVitalSignalsAverage(W,"left").pam,ie=i.getVitalSignalsAverage(te,"left").pam,re=i.getVitalSignalsAverage(W,"right").pam,ne=i.getVitalSignalsAverage(te,"right").pam,se=i.getFRCAverage([W.takes[0].frc,W.takes[1].frc,W.takes[2].frc]),oe=i.getFRCAverage([W.standing.frc,W.sitting.frc,W.lying_down.frc]),pe=i.getFRCAverage([W.takes[0].breathing_rate,W.takes[1].breathing_rate,W.takes[2].breathing_rate]),de=i.getFRCAverage([W.standing.breathing_rate,W.sitting.breathing_rate,W.lying_down.breathing_rate]),ce=i.getVitalSignalsAverage(W,"left").pulse_pressure,_e=i.getVitalSignalsAverage(te,"left").pulse_pressure,me=i.getVitalSignalsAverage(W,"right").pulse_pressure,le=i.getVitalSignalsAverage(te,"right").pulse_pressure,ue=ae-ie,he=re-ne,ge=pe-de,fe=se-oe,ye=ce-_e,ve=me-le,be={numeric:ue,percentage:ue/ie*100},xe={numeric:he,percentage:he/ne*100},Ie={numeric:ge,percentage:ge/de*100},ke={numeric:fe,percentage:fe/oe*100},we={numeric:ye,percentage:ye/_e*100},Ae={numeric:ve,percentage:ve/le*100};return{temperature:T,sat:R,take:X,averages:{pam:{left:be,right:xe},pulse_pressure:{left:we,right:Ae},br:Ie,frc:ke}}}if(t.hasOwnProperty("index")){$=W.takes[t.index],j=te.takes[t.index],L=parseInt($.breathing_rate),H=parseInt($.frc),B=parseInt(j.breathing_rate),G=parseInt(j.frc),J={};if(t.hasOwnProperty("arm")){V=parseInt($[t.arm]),Q=parseInt(j[t.arm]);J={numeric:V-Q,percent:(V-Q)/Q*100}}U={numeric:L-B,percent:(L-B)/B*100},K={numeric:H-G,percent:(H-G)/G*100};X={br:U,frc:K,arm:J}}return{temperature:T,sat:R,take:X,averages:Z}}return{temperature:{numeric:0,percent:0},sat:{numeric:0,percent:0},take:X,averages:Z}}return{temperature:{numeric:0,percent:0},sat:{numeric:0,percent:0},take:X,averages:Z};case"physical-exam":if(a){n=i.comparison.physical_exams;if(n.current_patient.hasOwnProperty("patient_id")&&n.patient_to_compare.hasOwnProperty("patient_id")){s=t.patient_to_compare?n.patient_to_compare:n.current_patient,o=t.patient_to_compare?n.current_patient:n.patient_to_compare;var Oe=parseInt(s.content.pvy.swivel_stop),De=parseInt(s.content.edema.range),Fe=parseInt(o.content.pvy.swivel_stop),Ee=parseInt(o.content.edema.range),Me={},Pe={mid:{},mii:{},symmetrical_range:{}};if(t.hasOwnProperty("soplo")){var Se=t.soplo,Ne=o.content.auscultation.soplo.items[t.i];if(void 0!==Ne){var ze=parseInt(Se.intensity_foco),qe=parseInt(Ne.intensity_foco),Ce=ze-qe,Ye={numeric:Ce,percent:Ce/(-1==Math.sign(Ce)?ze:qe)*100};Me=Ye}else Me={numeric:0,percent:0}}if(t.hasOwnProperty("pp")){var Te=parseInt(s.content.peripheral_pulses.mii),Re=parseInt(s.content.peripheral_pulses.mid),$e=parseInt(s.content.peripheral_pulses.symmetrical_range),je=parseInt(o.content.peripheral_pulses.mii),Le=parseInt(o.content.peripheral_pulses.mid),He=parseInt(o.content.peripheral_pulses.symmetrical_range),Be=Te-je,Ge=Re-Le,Je=$e-He,Ve={numeric:Be,percent:Be/(-1==Math.sign(Be)?Te:je)*100},Qe={numeric:Ge,percent:Ge/(-1==Math.sign(Ge)?Re:Le)*100},Ue={numeric:Je,percent:Je/(-1==Math.sign(Je)?$e:He)*100};Pe={mid:Qe,mii:Ve,symmetrical_range:Ue}}var Ke=Oe-Fe,Xe=De-Ee,Ze={numeric:Ke,percent:Ke/(-1==Math.sign(Ke)?Oe:Fe)*100},We={numeric:Xe,percent:Xe/(-1==Math.sign(Xe)?De:Ee)*100};return{pvy:{swivel_stop:Ze},auscultation:{soplo:Me},pp:Pe,edema:We}}return{}}n=i.patient_physical_exam;if(r.previous_appointment.hasOwnProperty("appointment_id")){var et=n.items[n.items.length-2];if(et.hasOwnProperty("appointment_id")){Oe=parseInt(n.content.pvy.swivel_stop),De=parseInt(n.content.edema.range),Fe=parseInt(et.content.pvy.swivel_stop),Ee=parseInt(et.content.edema.range),Me={},Pe={mid:{},mii:{},symmetrical_range:{}};if(t.hasOwnProperty("soplo")){ze=parseInt(t.soplo.intensity_foco),qe=parseInt(et.content.auscultation.soplo.items[t.i].intensity_foco),Ye={numeric:ze-qe,percent:(ze-qe)/qe*100};Me=Ye}if(t.hasOwnProperty("pp")){Te=parseInt(n.content.peripheral_pulses.mii),Re=parseInt(n.content.peripheral_pulses.mid),$e=parseInt(n.content.peripheral_pulses.symmetrical_range),je=parseInt(et.content.peripheral_pulses.mii),Le=parseInt(et.content.peripheral_pulses.mid),He=parseInt(et.content.peripheral_pulses.symmetrical_range),Ve={numeric:Te-je,percent:(Te-je)/je*100},Qe={numeric:Re-Le,percent:(Re-Le)/Le*100},Ue={numeric:$e-He,percent:($e-He)/He*100};Pe={mid:Qe,mii:Ve,symmetrical_range:Ue}}Ze={numeric:Oe-Fe,percent:(Oe-Fe)/Fe*100},We={numeric:De-Ee,percent:(De-Ee)/Ee*100};return{pvy:{swivel_stop:Ze},auscultation:{soplo:Me},pp:Pe,edema:We}}return{}}return{};case"electro-cardiogram":if(a){n=i.comparison.electro_cardiogram;if(n.current_patient.hasOwnProperty("patient_id")){s=t.patient_to_compare?n.patient_to_compare:n.current_patient,o=t.patient_to_compare?n.current_patient:n.patient_to_compare;var tt=parseInt(s.content.frecuency),at=parseInt(s.content.pr),it=parseInt(s.content.axes.qtc),rt=parseInt(s.content.axes.p),nt=parseInt(s.content.axes.qrs),st=parseInt(s.content.axes.t),ot=parseInt(o.content.frecuency),pt=parseInt(o.content.pr),dt=parseInt(o.content.axes.qtc),ct=parseInt(o.content.axes.p),_t=parseInt(o.content.axes.qrs),mt=parseInt(o.content.axes.t),lt={qtba:{},qtcal:{},qtfra:{},qtfri:{},qtrau:{},rr:{}};if(t.hasOwnProperty("qtc_calc")){var ut=parseInt(s.content.qtbaz),ht=parseInt(s.content.qtcal),gt=parseInt(s.content.qtfra),ft=parseInt(s.content.qtfri),yt=parseInt(s.content.qtrau),vt=parseFloat(s.content.rr),bt=parseInt(o.content.qtbaz),xt=parseInt(o.content.qtcal),It=parseInt(o.content.qtfra),kt=parseInt(o.content.qtfri),wt=parseInt(o.content.qtrau),At=parseFloat(o.content.rr);qtbaz_numeric_difference=ut-bt,qtcal_numeric_difference=ht-xt,qtfra_numeric_difference=gt-It,qtfri_numeric_difference=ft-kt,qtrau_numeric_difference=yt-wt,rr_numeric_difference=vt-At;var Ot={numeric:qtbaz_numeric_difference,percent:qtbaz_numeric_difference/(-1==Math.sign(qtbaz_numeric_difference)?ut:bt)*100},Dt={numeric:qtbaz_numeric_difference,percent:qtbaz_numeric_difference/(-1==Math.sign(qtbaz_numeric_difference)?ht:xt)*100},Ft={numeric:qtfra_numeric_difference,percent:qtfra_numeric_difference/(-1==Math.sign(qtbaz_numeric_difference)?gt:It)*100},Et={numeric:qtfri_numeric_difference,percent:qtfri_numeric_difference/(-1==Math.sign(qtfri_numeric_difference)?ft:kt)*100},Mt={numeric:qtrau_numeric_difference,percent:qtrau_numeric_difference/(-1==Math.sign(qtrau_numeric_difference)?yt:wt)*100},Pt={numeric:rr_numeric_difference,percent:rr_numeric_difference/(-1==Math.sign(rr_numeric_difference)?vt:At)*100};lt={qtcal:Dt,qtbaz:Ot,qtfra:Ft,qtfri:Et,qtrau:Mt,rr:Pt}}frecuency_numeric_difference=tt-ot,pr_numeric_difference=at-pt,qtc_numeric_difference=it-dt,axes_p_numeric_difference=rt-ct,axes_qrs_numeric_difference=nt-_t,axes_t_numeric_difference=st-mt;var St={numeric:frecuency_numeric_difference,percent:frecuency_numeric_difference/(-1==Math.sign(frecuency_numeric_difference)?tt:ot)*100},Nt={numeric:pr_numeric_difference,percent:pr_numeric_difference/(-1==Math.sign(pr_numeric_difference)?at:pt)*100},zt={numeric:qtc_numeric_difference,percent:qtc_numeric_difference/(-1==Math.sign(pr_numeric_difference)?at:pt)*100},qt={numeric:axes_p_numeric_difference,percent:axes_p_numeric_difference/(-1==Math.sign(axes_p_numeric_difference)?rt:ct)*100},Ct={numeric:axes_qrs_numeric_difference,percent:axes_qrs_numeric_difference/(-1==Math.sign(pr_numeric_difference)?nt:_t)*100},Yt={numeric:axes_t_numeric_difference,percent:axes_t_numeric_difference/(-1==Math.sign(axes_t_numeric_difference)?st:mt)*100};return{frecuency:St,qtc_r:lt,pr:Nt,qtc:zt,axes:{p:qt,qrs:Ct,t:Yt}}}return{}}n=i.patient_electro_cardiogram;if(r.previous_appointment.hasOwnProperty("appointment_id")){et=n.items[n.items.length-2];if(et.hasOwnProperty("appointment_id")){tt=parseInt(n.content.frecuency),at=parseInt(n.content.pr),it=parseInt(n.content.axes.qtc),rt=parseInt(n.content.axes.p),nt=parseInt(n.content.axes.qrs),st=parseInt(n.content.axes.t),ot=parseInt(et.content.frecuency),pt=parseInt(et.content.pr),dt=parseInt(et.content.axes.qtc),ct=parseInt(et.content.axes.p),_t=parseInt(et.content.axes.qrs),mt=parseInt(et.content.axes.t),lt={qtba:{},qtcal:{},qtfra:{},qtfri:{},qtrau:{},rr:{}};if(t.hasOwnProperty("qtc_calc")){ut=parseInt(n.content.qtbaz),ht=parseInt(n.content.qtcal),gt=parseInt(n.content.qtfra),ft=parseInt(n.content.qtfri),yt=parseInt(n.content.qtrau),vt=parseFloat(n.content.rr),bt=parseInt(et.content.qtbaz),xt=parseInt(et.content.qtcal),It=parseInt(et.content.qtfra),kt=parseInt(et.content.qtfri),wt=parseInt(et.content.qtrau),At=parseFloat(et.content.rr),Ot={numeric:ut-bt,percent:(ut-bt)/bt*100},Dt={numeric:ht-xt,percent:(ht-xt)/xt*100},Ft={numeric:gt-It,percent:(gt-It)/It*100},Et={numeric:ft-kt,percent:(ft-kt)/kt*100},Mt={numeric:yt-wt,percent:(yt-wt)/wt*100},Pt={numeric:vt-At,percent:(vt-At)/At*100};lt={qtcal:Dt,qtbaz:Ot,qtfra:Ft,qtfri:Et,qtrau:Mt,rr:Pt}}St={numeric:tt-ot,percent:(tt-ot)/ot*100},Nt={numeric:at-pt,percent:(at-pt)/pt*100},zt={numeric:it-dt,percent:(it-dt)/dt*100},qt={numeric:rt-ct,percent:(rt-ct)/ct*100},Ct={numeric:nt-_t,percent:(nt-_t)/_t*100},Yt={numeric:st-mt,percent:(st-mt)/mt*100};return{frecuency:St,qtc_r:lt,pr:Nt,qtc:zt,axes:{p:qt,qrs:Ct,t:Yt}}}return{}}return{};case"history":var Tt={numeric:0,percent:0};if(a){n=i.comparison.history;var Rt={dosis:Tt,daily_dosis:Tt};if(void 0!==n.current_patient||void 0!==n.patient_to_compare){s=t.patient_to_compare?n.patient_to_compare:n.current_patient,o=t.patient_to_compare?n.current_patient:n.patient_to_compare;if(void 0!==s&&void 0!==o){if(t.hasOwnProperty("dosis")){var $t=""!=s.history_content.treatments[t.treatment.group][t.treatment.treatment].dosis?parseInt(s.history_content.treatments[t.treatment.group][t.treatment.treatment].dosis):0,jt=""!=o.history_content.treatments[t.treatment.group][t.treatment.treatment].dosis?parseFloat(o.history_content.treatments[t.treatment.group][t.treatment.treatment].dosis):0,Lt=$t-jt,Ht={numeric:Lt,percent:Lt/(-1==Math.sign(Lt)?$t:jt)*100};Rt.dosis=Ht}else if(t.hasOwnProperty("daily_dosis")){var Bt=parseInt(s.history_content.treatments[t.treatment.group][t.treatment.treatment].daily_dosis),Gt=parseFloat(o.history_content.treatments[t.treatment.group][t.treatment.treatment].daily_dosis),Jt=Bt-Gt,Vt={numeric:Jt,percent:Jt/(-1==Math.sign(Jt)?Bt:Gt)*100};Rt.daily_dosis=Vt}return Rt}return{dosis:Tt,daily_dosis:Tt}}return{dosis:Tt,daily_dosis:Tt}}if(r.previous_appointment.hasOwnProperty("appointment_id")){n=i.patient_history;var Qt=n.items.find(e=>e.appointment_id==r.previous_appointment.appointment_id);Rt={dosis:Tt,daily_dosis:Tt};if(Qt.hasOwnProperty("appointment_id")){if(t.hasOwnProperty("dosis")){$t=""!=n.form.history_content.treatments[t.treatment.group][t.treatment.treatment].dosis?parseInt(n.form.history_content.treatments[t.treatment.group][t.treatment.treatment].dosis):0,jt=""!=Qt.history_content.treatments[t.treatment.group][t.treatment.treatment].dosis?parseFloat(Qt.history_content.treatments[t.treatment.group][t.treatment.treatment].dosis):0,Ht={numeric:$t-jt,percent:($t-jt)/jt*100};Rt.dosis=Ht}else if(t.hasOwnProperty("daily_dosis")){Bt=parseInt(n.form.history_content.treatments[t.treatment.group][t.treatment.treatment].daily_dosis),Gt=parseFloat(Qt.history_content.treatments[t.treatment.group][t.treatment.treatment].daily_dosis),Vt={numeric:Bt-Gt,percent:(Bt-Gt)/Gt*100};Rt.daily_dosis=Vt}return Rt}return{dosis:Tt,daily_dosis:Tt}}break;case"laboratory-exam":if(a){n=i.comparison.laboratory_exams,Tt={numeric:0,percent:0};if(null!=n.current_patient[0]&&n.current_patient[0].hasOwnProperty("patient_id")&&null!=n.patient_to_compare[0]&&n.patient_to_compare[0].hasOwnProperty("patient_id")){s=t.patient_to_compare?n.patient_to_compare[0]:n.current_patient[0],o=t.patient_to_compare?n.current_patient[0]:n.patient_to_compare[0],Rt={exam:Tt};var Ut=parseInt(s.results),Kt=parseFloat(o.results),Xt=Ut-Kt,Zt={numeric:Xt,percent:Xt/(-1==Math.sign(Xt)?Ut:Kt)*100};return Rt.exam=Zt,Rt}return{exam:Tt}}n=i.patient_laboratory_exams,Tt={numeric:0,percent:0};if(r.previous_appointment.hasOwnProperty("appointment_id")){var Wt=n.exam_results.indexOf(t.item),ea=n.exam_results[Wt],ta=n.exam_results[Wt-1];Rt={exam:Tt};if(void 0!==ta&&ta.hasOwnProperty("appointment_id")){Ut=parseInt(ea.results),Kt=parseFloat(ta.results),Zt={numeric:Ut-Kt,percent:(Ut-Kt)/Kt*100};return Rt.exam=Zt,Rt}return{exam:Tt}}return{exam:Tt};case"risk-factor-calc-list":Tt={numeric:0,percent:0};if(a){n=i.comparison.diagnostics.risk_factors,Rt={dosis:Tt,daily_dosis:Tt};if(n.current_patient.length>0||n.patient_to_compare.length>0){s=t.patient_to_compare?n.patient_to_compare:n.current_patient,o=t.patient_to_compare?n.current_patient:n.patient_to_compare;if(void 0!==s&&void 0!==o){var aa=t.item,ia=o.find(e=>e.name==aa.name);Rt={calc:Tt};if(void 0!==ia&&ia.hasOwnProperty("appointment_id")){Ut=parseFloat(aa.results),Kt=parseFloat(ia.results);var ra=Ut-Kt,na={numeric:ra,percent:ra/(-1==Math.sign(ra)?Ut:Kt)*100};return Rt.calc=na,Rt}return{calc:Tt}}return{dosis:Tt,daily_dosis:Tt}}return{dosis:Tt,daily_dosis:Tt}}n=i.patient_risk_factors;if(n.risk_factors_list.items.length>1){aa=t.item;var sa=r.appointments.indexOf(r.appointments.find(e=>e.appointment_id==aa.appointment_id)),oa=r.appointments[sa-1];if(null==oa)return{calc:Tt};ia=n.risk_factors_list.items.find(e=>e.appointment_id==oa.appointment_id&&e.name==aa.name);var pa=n.risk_factors_list.items.indexOf(n.risk_factors_list.items.find(e=>e.appointment_id==aa.appointment_id));ia=null==ia?pa?n.items[pa-1]:void 0:ia;Rt={calc:Tt};if(void 0!==ia&&ia.hasOwnProperty("appointment_id")){Ut=parseFloat(aa.results),Kt=parseFloat(ia.results);var da=Ut-Kt;na={numeric:da,percent:da/Kt*100};return Rt.calc=na,Rt}return{calc:Tt}}return{calc:Tt};case"risk-factor-calc":n=i.patient_risk_factors,Tt={numeric:0,percent:0};if(r.previous_appointment.hasOwnProperty("appointment_id")){aa=n.selectedForm,ia=n.risk_factors_calc_list.find(e=>e.appointment_id==r.previous_appointment.appointment_id),Rt={calc:Tt};if(void 0!==ia&&ia.hasOwnProperty("appointment_id")){Ut=parseFloat(aa.obj.results),Kt=parseFloat(ia.results),na={numeric:Ut-Kt,percent:(Ut-Kt)/Kt*100};return Rt.calc=na,Rt}return{calc:Tt}}return{calc:Tt};case"life-style":if(a){n=i.comparison.anthropometry;if(n.current_patient.hasOwnProperty("patient_id")&&n.patient_to_compare.hasOwnProperty("patient_id")){s=t.patient_to_compare?n.patient_to_compare:n.current_patient,o=t.patient_to_compare?n.current_patient:n.patient_to_compare,p=parseInt(s.abdominal_waist),d=parseInt(s.height),c=parseInt(s.weight),_=parseFloat(i.getBMI(c,d,s.weight_suffix,s.height_suffix).replace(" kg/m2","")),m=parseFloat(i.getCS(c,d,s.weight_suffix,s.height_suffix).replace(" m2","")),l=parseInt(o.abdominal_waist),u=parseInt(o.height),h=parseInt(o.weight),g=parseFloat(i.getBMI(h,u,o.weight_suffix,o.height_suffix).replace(" kg/m2","")),f=parseFloat(i.getCS(h,u,o.weight_suffix,o.height_suffix).replace(" m2","")),k={numeric:c-h,percent:(c-h)/h*100},w={numeric:d-u,percent:(d-u)/u*100},A={numeric:p-l,percent:(p-l)/l*100},O={numeric:_-g,percent:(_-g)/g*100},D={numeric:m-f,percent:(m-f)/f*100};return{weight:k,height:w,abdominal_waist:A,
bmi:O,cs:D}}return{}}n=i.patient_life_style,F={aerobic_weekly_minutes:{numeric:0,apercentage:0},resistance_weekly_minutes:{numeric:0,apercentage:0},smoking:{cigarettes_per_day:{numeric:0,apercentage:0}}};if(n.items.length>1){var ca=void 0!==t&&t.hasOwnProperty("life_style")?t.life_style:n.editedItem;M=r.appointments.indexOf(r.appointments.find(e=>e.appointment_id==ca.appointment_id)),P=r.appointments[M-1];if(null==P)return F;var _a=n.items.find(e=>e.appointment_id==P.appointment_id);N=n.items.indexOf(ca);if(_a=null==_a?n.items[N-1]:_a,void 0!==_a&&_a.hasOwnProperty("appointment_id")){var ma=parseInt(ca.aerobic_weekly_minutes),la=parseInt(ca.resistance_weekly_minutes),ua=parseInt(ca.smoking.cigarettes_per_day),ha=parseInt(_a.aerobic_weekly_minutes),ga=parseInt(_a.resistance_weekly_minutes),fa=parseInt(_a.smoking.cigarettes_per_day),ya=ma-ha,va=la-ga,ba=ua-fa,xa=!parseInt(ca.sedentary)&&ca.exercise.type.includes("Aeróbico")&&!parseInt(_a.sedentary)&&_a.exercise.type.includes("Aeróbico")?{numeric:ya,percent:ya/ha*100}:F.aerobic_weekly_minutes,Ia=!parseInt(ca.sedentary)&&ca.exercise.type.includes("Resistencia")&&!parseInt(_a.sedentary)&&_a.exercise.type.includes("Resistencia")?{numeric:va,percent:va/ga*100}:F.resistance_weekly_minutes,ka={numeric:ba,percent:ba/fa*100};return{aerobic_weekly_minutes:xa,resistance_weekly_minutes:Ia,smoking:{cigarettes_per_day:ka}}}return F}return F}},returnNumberSign(e){var t="";return 1==Math.sign(e)&&0!==e&&e!==1/0&&NaN!==e?t="+":-1==Math.sign(e)&&0!==e&&e!==1/0&&NaN!==e?t="":(t="",e=0),t+e},filterFollowUpsAppointments(e,t=!1){var a=this,i=a.patient_appointments;a.FollowUpAppointmentsDialog=!1;var r=i.appointments.indexOf(e);if(i.previous_appointment=r>0?i.appointments[r-1]:{},a.view_dialog)switch(a.view_tab){case"tab-view-3":a.initializeHistory();break;case"tab-view-4":a.initializeAnthropometry();break;case"tab-view-5":a.initializeVitalSigns();break;case"tab-view-6":a.initializePhysicalExams();break;case"tab-view-7":a.initializeElectroCardiograms();break;case"tab-view-8":a.initializeEchocardiograms();break;case"tab-view-9":a.initializeExams(),a.initializeExamsFiles();break;case"tab-view-10":a.initializeFactorsRisk(!0);break;case"tab-view-11":a.initializeLifeStyle();break;case"tab-view-12":a.initializePlans()}else switch(a.tab){case"tab-3":a.initializeHistory();break;case"tab-4":a.initializeAnthropometry();break;case"tab-5":a.initializeVitalSigns();break;case"tab-6":a.initializePhysicalExams();break;case"tab-7":a.initializeElectroCardiograms();break;case"tab-8":a.initializeEchocardiograms();break;case"tab-9":a.initializeExams(),a.initializeExamsFiles();break;case"tab-10":a.initializeFactorsRisk(a.view_dialog);break;case"tab-11":a.initializeLifeStyle();break;case"tab-12":a.initializeFactorsRisk(),a.initializePlans()}},searchTemplate(){return this.filtered_templates=this.templates.filter(e=>e.material_name.toLowerCase().includes(this.template_search.toLowerCase()))},getTelephoneInput(e,t){this.editedItem.telephone=t.number.international}}});