...
;""!=e.patient_risk_factors.selectedForm.calc_name&&e.getCurrentFactorRisk(),e.setAnthropometryVars(),e.patient_risk_factors.selectedForm.obj.vars.age=moment(e.editedItem.birthdate,"YYYY-MM-DD").fromNow().split(" ")[1],e.patient_risk_factors.selectedForm.obj.vars.gender=e.editedItem.gender},getBMI(e,t,a,i){if(0!=t&&0!=e){e="lb"==a?e/2.205:e,t="in"==i?2.54*t:t,t=Math.pow(t/100,2);var r=Math.round(10*e/t)/10;return NaN!=typeof r&&(r+=" kg/m2"),r}return""},getCS(e,t,a,i){if(0!=t&&0!=e){e="lb"==a?e/2.205:e,t="in"==i?2.54*t:t;var r=3600,n=Math.pow(t*e/r,.5),s=Math.round(100*n)/100;return NaN!=typeof s&&(s+=" m2"),s}return""},getVitalSignalsAverage(e,t){var a=0;if(sitting=e.sitting,lying_down=e.lying_down,standing=e.standing,"left"==t){0==parseInt(sitting.pa_left_arm1)&&0==parseInt(sitting.pa_left_arm2)||a++,0==parseInt(lying_down.pa_left_arm1)&&0==parseInt(lying_down.pa_left_arm2)||a++,0==parseInt(standing.pa_left_arm1)&&0==parseInt(standing.pa_left_arm2)||a++;var i=Math.round((parseInt(sitting.pa_left_arm1)+parseInt(lying_down.pa_left_arm1)+parseInt(standing.pa_left_arm1))/a),r=Math.round((parseInt(sitting.pa_left_arm2)+parseInt(lying_down.pa_left_arm2)+parseInt(standing.pa_left_arm2))/a),n=i-r,s=Math.round(r- -(i-r)/a);return{pulse_pressure:n,pam:s}}if("right"==t){0==parseInt(sitting.pa_right_arm1)&&0==parseInt(sitting.pa_right_arm2)||a++,0==parseInt(lying_down.pa_right_arm1)&&0==parseInt(lying_down.pa_right_arm2)||a++,0==parseInt(standing.pa_right_arm1)&&0==parseInt(standing.pa_right_arm2)||a++;i=Math.round((parseInt(sitting.pa_right_arm1)+parseInt(lying_down.pa_right_arm1)+parseInt(standing.pa_right_arm1))/a),r=Math.round((parseInt(sitting.pa_right_arm2)+parseInt(lying_down.pa_right_arm2)+parseInt(standing.pa_right_arm2))/a),n=i-r,s=Math.round(r- -(i-r)/a);return{pulse_pressure:n,pam:s}}},getAverage(e,t,a){var i=this,r=0,n=0;return e.forEach(e=>{if(0==parseInt(e)||null==typeof e||""==e)return!1;r++;var t=parseInt(e);n+=t}),r>0&&(n=Math.round(n/r)),i.patient_vital_signs.takes[t][a]=n,n},getFRCAverage(e){var t=0,a=0;return e.forEach(e=>{if(0==parseInt(e)||null==typeof e||""==e)return!1;t++;var i=parseInt(e);a+=i}),t>0&&(a=Math.round(a/t)),a},getSDverage(e){var t=0,a=0;return e.forEach(e=>{if(0==parseInt(e)||null==typeof e||""==e)return!1;t++;var i=parseInt(e);a+=i}),t>0&&(a=Math.round(a/t)),a},calcCholesterolLDL(){var e=this;if(!e.$refs.ple_formulas_cholesterol_ldl.validate())return!1;var t=e.patient_laboratory_exams.formulas.cholesterol_ldl;e.patient_laboratory_exams.formulas.cholesterol_ldl.results=parseInt(t.vars.total_cholesterol)-parseInt(t.vars.c_HDL),e.patient_laboratory_exams.editedItem.results=parseInt(t.vars.total_cholesterol)-parseInt(t.vars.c_HDL)-parseInt(t.vars.triglyceride_level/5)},calcCholesterolNoHDL(){var e=this,t=e.patient_laboratory_exams.formulas.cholesterol_no_hdl;e.patient_laboratory_exams.formulas.cholesterol_ldl.results=parseInt(t.vars.total_cholesterol)-parseInt(t.vars.c_HDL),e.patient_laboratory_exams.editedItem.results=parseInt(t.vars.total_cholesterol)-parseInt(t.vars.c_HDL)},calcQTC(){var e=this,t=e.patient_electro_cardiogram.content,a=t.qt,i=t.fc;t.rr=60/parseInt(i),t.rr=parseFloat(t.rr),t.qtrau=656/(1+parseInt(i)/100),t.qtrau=parseInt(t.qtrau),t.qtbaz=parseInt(a)/Math.sqrt(parseFloat(t.rr)),t.qtbaz=parseInt(t.qtbaz),t.qtfra=parseInt(a)+.154*(1-parseFloat(t.rr)),t.qtfra=parseInt(t.qtfra),t.qtfri=parseInt(a)/Math.pow(parseFloat(t.rr),1/3),t.qtfri=parseInt(t.qtfri),t.qtcal=parseInt(a)/Math.pow(parseFloat(t.rr)*parseFloat(t.rr),.2),t.qtcal=parseInt(t.qtcal)},fagerstromTest(){var e=this,t=e.patient_life_style.calc.fagerstrom,a=t.vars,i=a.input1+a.input2+a.input3+a.input4+a.input5+a.input6;return t.result=i,i},getFagerStromScoreDescription(e){var t=this,a=e?parseInt(t.patient_life_style.calc.fagerstrom.result):parseInt(t.patient_life_style.editedItem.smoking.fagerstrom_test),i="";return i=""==a?"":a>=0&&a<=2?"Dependencia MUY BAJA":a>=3&&a<=4?"Dependencia BAJA":5==a?"Dependencia MODERADA":a>=6&&a<=7?"Dependencia ALTA":a>=8&&a<=10?"Dependencia ALTA":"",i},pregnancyAlert(e){var t=this,a=e,i="",r=a.find(e=>e.includes("BRA")||e.includes("IECAS"));return i=null!=r&&r.length>0&&"F"==t.editedItem.gender,i},gfrCkdEpiFx(){var e=this,t=e.editedItem,a=t.gender,i=e.patient_laboratory_exams.formulas.filt_glom,r="M"==a?1:1.018,n="M"==a?-.411:-.329,s="M"==a?.9:.7,o=i.vars.serum_creatinine,p=i.vars.race,d=parseFloat(moment().diff(t.birthdate,"years")),_=141*Math.pow(Math.min(o/s,1),n)*Math.pow(Math.max(o/s,1),-1.209)*Math.pow(.993,d)*r*p;return e.patient_laboratory_exams.formulas.filt_glom.results=_.toFixed(2),e.patient_laboratory_exams.editedItem.results=_.toFixed(2),_.toFixed(2)},gfrRrmdFx(){var e=this,t=e.editedItem,a=t.gender,i=e.patient_laboratory_exams.formulas.egfr_mdr_ckdepi,r="M"==a?1:.742,n=i.vars.serum_creatinine,s=i.vars.race,o=parseFloat(moment().diff(t.birthdate,"years"));Math.pow(n,-1.154),Math.pow(o,-.203);var p=175*Math.pow(n,-1.154)*Math.pow(o,-.203)*r*s;return e.patient_laboratory_exams.formulas.egfr_mdr_ckdepi.results=p.toFixed(2),e.patient_laboratory_exams.editedItem.results=p.toFixed(2),p.toFixed(2)},assignGFRVars(e){var t=this.patient_laboratory_exams.formulas,a=this.patient_laboratory_exams.formulas.egfr_mdr_ckdepi.vars;"CKD-EPI"==e&&(t.filt_glom.vars.serum_creatinine=a.serum_creatinine,t.filt_glom.vars.race=1.21==a.race?1.159:1)},prevImage(e){const t=e.target.files[0],a=new FileReader;a.readAsDataURL(t),a.onload=(e=>{this.editedItem.avatar=t,this.previewImage=e.target.result,this.upload_button=!0})},uploadImage(e){var t=this;let a=new FormData;var i=api_url+"patients/update-avatar";t.image_loading=!0,t.image_loading=!0,a.append("patient_id",t.editedItem.patient_id),a.append("avatar",t.editedItem.avatar),t.$http.post(i,a).then(e=>{t.image_loading=!1,"success"==e.body.status&&(t.upload_button=!1,t.editedItem.avatar=e.body.data.avatar),activateAlert(e.body.message,e.body.status)},e=>{})},diagnosticDateCheck(e){if(!e.detected_previously){if("Menos de un año"==e.diagnostic_date||"Entre 1 y 2 años"==e.diagnostic_date||"3 a 4 años"==e.diagnostic_date||"4 a 5 años"==e.diagnostic_date||"Más de 5 años"==e.diagnostic_date||"Más de 10 años"==e.diagnostic_date)return e.diagnostic_date=moment().format("YYYY[-]MM[-]DD"),!0;e.diagnostic_date=""==e.diagnostic_date?moment().format("YYYY[-]MM[-]DD"):e.diagnostic_date}},fromNow:e=>moment(e).format("LL"),getCurrentDate:e=>moment().format("YYYY-MM-DD"),addItemToArray(e,t){""==e&&null==typeof e||t.push(e)},addObjectToArray(e,t){""==e&&null==typeof e||t.push({name:e,group:"Group 4"})},getClinicExamsActive(e){var t=e.filter((e,t)=>parseInt(e.value));return t},getTimeDiff:e=>moment().diff(e,"years"),getOnlyYear:e=>""==e?"":moment(e).format("YYYY"),displayOnlyYear:e=>e.substring(0,4),resetPatientInformation(){this.patient_appointments.appointments=[]},searchFRTreatment(e){var t=this,a=t.patient_risk_factors;if(a.rf.hasOwnProperty("created_at")&&a.risk_factors_diagnostics.length>1){var i=a.risk_factors_diagnostics.length,r=a.rf.hasOwnProperty("created_at")?i-2:i-1,n=a.risk_factors_diagnostics[r].risk_factors.find(t=>t.name==e);return void 0!==n&&"Sí"==n.diagnostic&&"Sí"==n.has_treatment?n.comment:""}return""},hasPreviousFRTreatment(e){var t=this,a=t.patient_risk_factors;if(!t.patient_appointments.previous_appointment.hasOwnProperty("appointment_id"))return!1;if(a.risk_factors_diagnostics.length>1){var i=a.risk_factors_diagnostics.length,r=a.rf.hasOwnProperty("created_at")?i-2:i-1,n=a.risk_factors_diagnostics[r].risk_factors.find(t=>t.name==e);return void 0!==n&&"Sí"==n.diagnostic&&"Sí"==n.has_treatment}},previousFRTreatmentDescription(e,t,a=!1){var i=this,r=i.patient_risk_factors;if(r.rf.hasOwnProperty("created_at")&&r.risk_factors_diagnostics.length>1){var n=r.risk_factors_diagnostics.length,s=r.risk_factors_diagnostics[n-2].risk_factors.find(t=>t.name==e);return void 0!==s&&"Sí"==s.diagnostic&&"Sí"==s.has_treatment&&s.comment!=t&&""!=t?a?"Previo: "+s.comment:"Tratamiento cambiado de "+s.comment+" a "+t:""}n=r.risk_factors_diagnostics.length;return void 0!==r.risk_factors_diagnostics[n-1]?(s=r.risk_factors_diagnostics[n-1].risk_factors.find(t=>t.name==e),void 0!==s&&"Sí"==s.diagnostic&&"Sí"==s.has_treatment&&s.comment!=t&&""!=t?a?"Previo: "+s.comment:"Tratamiento cambiado de "+s.comment+" a "+t:""):""},getPercentDifference(e,t,a=!1){var i=this,r=i.patient_appointments;switch(t=void 0===t?{}:t,e){case"anthropometry":if(a){var n=i.comparison.anthropometry;if(n.current_patient.hasOwnProperty("patient_id")&&n.patient_to_compare.hasOwnProperty("patient_id")){var s=t.patient_to_compare?n.patient_to_compare:n.current_patient,o=t.patient_to_compare?n.current_patient:n.patient_to_compare,p=parseInt(s.abdominal_waist),d=parseInt(s.height),_=parseInt(s.weight),c=parseFloat(i.getBMI(_,d,s.weight_suffix,s.height_suffix).replace(" kg/m2","")),m=parseFloat(i.getCS(_,d,s.weight_suffix,s.height_suffix).replace(" m2","")),l=parseInt(o.abdominal_waist),u=parseInt(o.height),h=parseInt(o.weight),g=parseFloat(i.getBMI(h,u,o.weight_suffix,o.height_suffix).replace(" kg/m2","")),f=parseFloat(i.getCS(h,u,o.weight_suffix,o.height_suffix).replace(" m2","")),y={numeric:_-h,percent:(_-h)/h*100},v={numeric:d-u,percent:(d-u)/u*100},b={numeric:p-l,percent:(p-l)/l*100},x={numeric:c-g,percent:(c-g)/g*100},I={numeric:m-f,percent:(m-f)/f*100};return{weight:y,height:v,abdominal_waist:b,bmi:x,cs:I}}return{}}n=i.patient_anthropometry;var k={weight:0,height:0,abdominal_waist:0,bmi:0,cs:0};if(n.history.length>1){var w=void 0!==t&&t.hasOwnProperty("anthropometry")?t.anthropometry:n.editedItem,A=r.appointments.indexOf(r.appointments.find(e=>e.appointment_id==w.appointment_id)),D=r.appointments[A-1];if(null==D)return k;var O=n.history.find(e=>e.appointment_id==D.appointment_id),E=n.history.indexOf(w);if(O=null==O?n.history[E-1]:O,void 0!==O&&O.hasOwnProperty("appointment_id")){t.hasOwnProperty("anthropometry");p=parseInt(w.abdominal_waist),d=parseInt(w.height),_=parseInt(w.weight),c=parseFloat(i.getBMI(_,d,n.editedItem.weight_suffix,n.editedItem.height_suffix).replace(" kg/m2","")),m=parseFloat(i.getCS(_,d,n.editedItem.weight_suffix,n.editedItem.height_suffix).replace(" m2","")),l=parseInt(O.abdominal_waist),u=parseInt(O.height),h=parseInt(O.weight),g=parseFloat(i.getBMI(h,u,O.weight_suffix,O.height_suffix).replace(" kg/m2","")),f=parseFloat(i.getCS(h,u,O.weight_suffix,O.height_suffix).replace(" m2","")),y={numeric:_-h,percent:(_-h)/h*100},v={numeric:d-u,percent:(d-u)/u*100},b={numeric:p-l,percent:(p-l)/l*100},x={numeric:c-g,percent:(c-g)/g*100},I={numeric:m-f,percent:(m-f)/f*100};return{weight:y,height:v,abdominal_waist:b,bmi:x,cs:I}}return k}return k;case"vital-signals":if(a){n=i.comparison.vital_signs;if(n.current_patient.hasOwnProperty("patient_id")&&n.patient_to_compare.hasOwnProperty("patient_id")){s=t.patient_to_compare?n.patient_to_compare:n.current_patient,o=t.patient_to_compare?n.current_patient:n.patient_to_compare;var F=parseInt(s.sat),M=parseInt(s.sat),P=parseInt(o.lying_down.temperature),N=parseInt(o.lying_down.sat),q={numeric:F-P,percent:(F-P)/P*100},z={numeric:M-N,percent:(M-N)/N*100};if(takes={},t.hasOwnProperty("index")){var Y=s.takes[t.index],S=o.takes[t.index],C=parseInt(Y.breathing_rate),T=parseInt(Y.frc),$=parseInt(S.breathing_rate),R=parseInt(S.frc),j={};if(t.hasOwnProperty("arm")){var L=parseInt(Y[t.arm]),H=parseInt(S[t.arm]);j={numeric:L-H,percent:(L-H)/H*100}}var B={numeric:C-$,percent:(C-$)/$*100},G={numeric:T-R,percent:(T-R)/R*100};takes={br:B,frc:G,arm:j}}return{temperature:q,sat:z,take:takes}}return{}}n=i.patient_vital_signs;if(r.previous_appointment.hasOwnProperty("appointment_id")){var J=n.records.find(e=>e.appointment_id==r.previous_appointment.appointment_id);if(null==J&&(J=n.records[n.records.length-2]),J.hasOwnProperty("appointment_id")){F=parseInt(n.sat),M=parseInt(n.sat),P=parseInt(J.lying_down.temperature),N=parseInt(J.lying_down.sat),q={numeric:F-P,percent:(F-P)/P*100},z={numeric:M-N,percent:(M-N)/N*100};if(takes={},t.hasOwnProperty("index")){Y=n.takes[t.index],S=J.takes[t.index],C=parseInt(Y.breathing_rate),T=parseInt(Y.frc),$=parseInt(S.breathing_rate),R=parseInt(S.frc),j={};if(t.hasOwnProperty("arm")){L=parseInt(Y[t.arm]),H=parseInt(S[t.arm]);j={numeric:L-H,percent:(L-H)/H*100}}B={numeric:C-$,percent:(C-$)/$*100},G={numeric:T-R,percent:(T-R)/R*100};takes={br:B,frc:G,arm:j}}return{temperature:q,sat:z,take:takes}}return{}}break;case"physical-exam":if(a){n=i.comparison.physical_exams;if(n.current_patient.hasOwnProperty("patient_id")&&n.patient_to_compare.hasOwnProperty("patient_id")){s=t.patient_to_compare?n.patient_to_compare:n.current_patient,o=t.patient_to_compare?n.current_patient:n.patient_to_compare;var V=parseInt(s.content.pvy.swivel_stop),Q=parseInt(s.content.edema.range),U=parseInt(o.content.pvy.swivel_stop),K=parseInt(o.content.edema.range),Z={},W={mid:{},mii:{},symmetrical_range:{}};if(t.hasOwnProperty("soplo")){var X=t.soplo,ee=o.content.auscultation.soplo.items[t.i];if(void 0!==ee){var te=parseInt(X.intensity_foco),ae=parseInt(ee.intensity_foco),ie=te-ae,re={numeric:ie,percent:ie/(-1==Math.sign(ie)?te:ae)*100};Z=re}else Z={numeric:0,percent:0}}if(t.hasOwnProperty("pp")){var ne=parseInt(s.content.peripheral_pulses.mii),se=parseInt(s.content.peripheral_pulses.mid),oe=parseInt(s.content.peripheral_pulses.symmetrical_range),pe=parseInt(o.content.peripheral_pulses.mii),de=parseInt(o.content.peripheral_pulses.mid),_e=parseInt(o.content.peripheral_pulses.symmetrical_range),ce=ne-pe,me=se-de,le=oe-_e,ue={numeric:ce,percent:ce/(-1==Math.sign(ce)?ne:pe)*100},he={numeric:me,percent:me/(-1==Math.sign(me)?se:de)*100},ge={numeric:le,percent:le/(-1==Math.sign(le)?oe:_e)*100};W={mid:he,mii:ue,symmetrical_range:ge}}var fe=V-U,ye=Q-K,ve={numeric:fe,percent:fe/(-1==Math.sign(fe)?V:U)*100},be={numeric:ye,percent:ye/(-1==Math.sign(ye)?Q:K)*100};return{pvy:{swivel_stop:ve},auscultation:{soplo:Z},pp:W,edema:be}}return{}}n=i.patient_physical_exam;if(r.previous_appointment.hasOwnProperty("appointment_id")){var xe=n.items[n.items.length-2];if(xe.hasOwnProperty("appointment_id")){V=parseInt(n.content.pvy.swivel_stop),Q=parseInt(n.content.edema.range),U=parseInt(xe.content.pvy.swivel_stop),K=parseInt(xe.content.edema.range),Z={},W={mid:{},mii:{},symmetrical_range:{}};if(t.hasOwnProperty("soplo")){te=parseInt(t.soplo.intensity_foco),ae=parseInt(xe.content.auscultation.soplo.items[t.i].intensity_foco),re={numeric:te-ae,percent:(te-ae)/ae*100};Z=re}if(t.hasOwnProperty("pp")){ne=parseInt(n.content.peripheral_pulses.mii),se=parseInt(n.content.peripheral_pulses.mid),oe=parseInt(n.content.peripheral_pulses.symmetrical_range),pe=parseInt(xe.content.peripheral_pulses.mii),de=parseInt(xe.content.peripheral_pulses.mid),_e=parseInt(xe.content.peripheral_pulses.symmetrical_range),ue={numeric:ne-pe,percent:(ne-pe)/pe*100},he={numeric:se-de,percent:(se-de)/de*100},ge={numeric:oe-_e,percent:(oe-_e)/_e*100};W={mid:he,mii:ue,symmetrical_range:ge}}ve={numeric:V-U,percent:(V-U)/U*100},be={numeric:Q-K,percent:(Q-K)/K*100};return{pvy:{swivel_stop:ve},auscultation:{soplo:Z},pp:W,edema:be}}return{}}return{};case"electro-cardiogram":if(a){n=i.comparison.electro_cardiogram;if(n.current_patient.hasOwnProperty("patient_id")){s=t.patient_to_compare?n.patient_to_compare:n.current_patient,o=t.patient_to_compare?n.current_patient:n.patient_to_compare;var Ie=parseInt(s.content.frecuency),ke=parseInt(s.content.pr),we=parseInt(s.content.axes.qtc),Ae=parseInt(s.content.axes.p),De=parseInt(s.content.axes.qrs),Oe=parseInt(s.content.axes.t),Ee=parseInt(o.content.frecuency),Fe=parseInt(o.content.pr),Me=parseInt(o.content.axes.qtc),Pe=parseInt(o.content.axes.p),Ne=parseInt(o.content.axes.qrs),qe=parseInt(o.content.axes.t),ze={qtba:{},qtcal:{},qtfra:{},qtfri:{},qtrau:{},rr:{}};if(t.hasOwnProperty("qtc_calc")){var Ye=parseInt(s.content.qtbaz),Se=parseInt(s.content.qtcal),Ce=parseInt(s.content.qtfra),Te=parseInt(s.content.qtfri),$e=parseInt(s.content.qtrau),Re=parseFloat(s.content.rr),je=parseInt(o.content.qtbaz),Le=parseInt(o.content.qtcal),He=parseInt(o.content.qtfra),Be=parseInt(o.content.qtfri),Ge=parseInt(o.content.qtrau),Je=parseFloat(o.content.rr);qtbaz_numeric_difference=Ye-je,qtcal_numeric_difference=Se-Le,qtfra_numeric_difference=Ce-He,qtfri_numeric_difference=Te-Be,qtrau_numeric_difference=$e-Ge,rr_numeric_difference=Re-Je;var Ve={numeric:qtbaz_numeric_difference,percent:qtbaz_numeric_difference/(-1==Math.sign(qtbaz_numeric_difference)?Ye:je)*100},Qe={numeric:qtbaz_numeric_difference,percent:qtbaz_numeric_difference/(-1==Math.sign(qtbaz_numeric_difference)?Se:Le)*100},Ue={numeric:qtfra_numeric_difference,percent:qtfra_numeric_difference/(-1==Math.sign(qtbaz_numeric_difference)?Ce:He)*100},Ke={numeric:qtfri_numeric_difference,percent:qtfri_numeric_difference/(-1==Math.sign(qtfri_numeric_difference)?Te:Be)*100},Ze={numeric:qtrau_numeric_difference,percent:qtrau_numeric_difference/(-1==Math.sign(qtrau_numeric_difference)?$e:Ge)*100},We={numeric:rr_numeric_difference,percent:rr_numeric_difference/(-1==Math.sign(rr_numeric_difference)?Re:Je)*100};ze={qtcal:Qe,qtbaz:Ve,qtfra:Ue,qtfri:Ke,qtrau:Ze,rr:We}}frecuency_numeric_difference=Ie-Ee,pr_numeric_difference=ke-Fe,qtc_numeric_difference=we-Me,axes_p_numeric_difference=Ae-Pe,axes_qrs_numeric_difference=De-Ne,axes_t_numeric_difference=Oe-qe;var Xe={numeric:frecuency_numeric_difference,percent:frecuency_numeric_difference/(-1==Math.sign(frecuency_numeric_difference)?Ie:Ee)*100},et={numeric:pr_numeric_difference,percent:pr_numeric_difference/(-1==Math.sign(pr_numeric_difference)?ke:Fe)*100},tt={numeric:qtc_numeric_difference,percent:qtc_numeric_difference/(-1==Math.sign(pr_numeric_difference)?ke:Fe)*100},at={numeric:axes_p_numeric_difference,percent:axes_p_numeric_difference/(-1==Math.sign(axes_p_numeric_difference)?Ae:Pe)*100},it={numeric:axes_qrs_numeric_difference,percent:axes_qrs_numeric_difference/(-1==Math.sign(pr_numeric_difference)?De:Ne)*100},rt={numeric:axes_t_numeric_difference,percent:axes_t_numeric_difference/(-1==Math.sign(axes_t_numeric_difference)?Oe:qe)*100};return{frecuency:Xe,qtc_r:ze,pr:et,qtc:tt,axes:{p:at,qrs:it,t:rt}}}return{}}n=i.patient_electro_cardiogram;if(r.previous_appointment.hasOwnProperty("appointment_id")){xe=n.items[n.items.length-2];if(xe.hasOwnProperty("appointment_id")){Ie=parseInt(n.content.frecuency),ke=parseInt(n.content.pr),we=parseInt(n.content.axes.qtc),Ae=parseInt(n.content.axes.p),De=parseInt(n.content.axes.qrs),Oe=parseInt(n.content.axes.t),Ee=parseInt(xe.content.frecuency),Fe=parseInt(xe.content.pr),Me=parseInt(xe.content.axes.qtc),Pe=parseInt(xe.content.axes.p),Ne=parseInt(xe.content.axes.qrs),qe=parseInt(xe.content.axes.t),ze={qtba:{},qtcal:{},qtfra:{},qtfri:{},qtrau:{},rr:{}};if(t.hasOwnProperty("qtc_calc")){Ye=parseInt(n.content.qtbaz),Se=parseInt(n.content.qtcal),Ce=parseInt(n.content.qtfra),Te=parseInt(n.content.qtfri),$e=parseInt(n.content.qtrau),Re=parseFloat(n.content.rr),je=parseInt(xe.content.qtbaz),Le=parseInt(xe.content.qtcal),He=parseInt(xe.content.qtfra),Be=parseInt(xe.content.qtfri),Ge=parseInt(xe.content.qtrau),Je=parseFloat(xe.content.rr),Ve={numeric:Ye-je,percent:(Ye-je)/je*100},Qe={numeric:Se-Le,percent:(Se-Le)/Le*100},Ue={numeric:Ce-He,percent:(Ce-He)/He*100},Ke={numeric:Te-Be,percent:(Te-Be)/Be*100},Ze={numeric:$e-Ge,percent:($e-Ge)/Ge*100},We={numeric:Re-Je,percent:(Re-Je)/Je*100};ze={qtcal:Qe,qtbaz:Ve,qtfra:Ue,qtfri:Ke,qtrau:Ze,rr:We}}Xe={numeric:Ie-Ee,percent:(Ie-Ee)/Ee*100},et={numeric:ke-Fe,percent:(ke-Fe)/Fe*100},tt={numeric:we-Me,percent:(we-Me)/Me*100},at={numeric:Ae-Pe,percent:(Ae-Pe)/Pe*100},it={numeric:De-Ne,percent:(De-Ne)/Ne*100},rt={numeric:Oe-qe,percent:(Oe-qe)/qe*100};return{frecuency:Xe,qtc_r:ze,pr:et,qtc:tt,axes:{p:at,qrs:it,t:rt}}}return{}}return{};case"history":var nt={numeric:0,percent:0};if(a){n=i.comparison.history;var st={dosis:nt,daily_dosis:nt};if(void 0!==n.current_patient||void 0!==n.patient_to_compare){s=t.patient_to_compare?n.patient_to_compare:n.current_patient,o=t.patient_to_compare?n.current_patient:n.patient_to_compare;if(void 0!==s&&void 0!==o){if(t.hasOwnProperty("dosis")){var ot=""!=s.history_content.treatments[t.treatment.group][t.treatment.treatment].dosis?parseInt(s.history_content.treatments[t.treatment.group][t.treatment.treatment].dosis):0,pt=""!=o.history_content.treatments[t.treatment.group][t.treatment.treatment].dosis?parseFloat(o.history_content.treatments[t.treatment.group][t.treatment.treatment].dosis):0,dt=ot-pt,_t={numeric:dt,percent:dt/(-1==Math.sign(dt)?ot:pt)*100};st.dosis=_t}else if(t.hasOwnProperty("daily_dosis")){var ct=parseInt(s.history_content.treatments[t.treatment.group][t.treatment.treatment].daily_dosis),mt=parseFloat(o.history_content.treatments[t.treatment.group][t.treatment.treatment].daily_dosis),lt=ct-mt,ut={numeric:lt,percent:lt/(-1==Math.sign(lt)?ct:mt)*100};st.daily_dosis=ut}return st}return{dosis:nt,daily_dosis:nt}}return{dosis:nt,daily_dosis:nt}}if(r.previous_appointment.hasOwnProperty("appointment_id")){n=i.patient_history;var ht=n.items.find(e=>e.appointment_id==r.previous_appointment.appointment_id);st={dosis:nt,daily_dosis:nt};if(ht.hasOwnProperty("appointment_id")){if(t.hasOwnProperty("dosis")){ot=""!=n.form.history_content.treatments[t.treatment.group][t.treatment.treatment].dosis?parseInt(n.form.history_content.treatments[t.treatment.group][t.treatment.treatment].dosis):0,pt=""!=ht.history_content.treatments[t.treatment.group][t.treatment.treatment].dosis?parseFloat(ht.history_content.treatments[t.treatment.group][t.treatment.treatment].dosis):0,_t={numeric:ot-pt,percent:(ot-pt)/pt*100};st.dosis=_t}else if(t.hasOwnProperty("daily_dosis")){ct=parseInt(n.form.history_content.treatments[t.treatment.group][t.treatment.treatment].daily_dosis),mt=parseFloat(ht.history_content.treatments[t.treatment.group][t.treatment.treatment].daily_dosis),ut={numeric:ct-mt,percent:(ct-mt)/mt*100};st.daily_dosis=ut}return st}return{dosis:nt,daily_dosis:nt}}break;case"laboratory-exam":if(a){n=i.comparison.laboratory_exams,nt={numeric:0,percent:0};if(null!=n.current_patient[0]&&n.current_patient[0].hasOwnProperty("patient_id")&&null!=n.patient_to_compare[0]&&n.patient_to_compare[0].hasOwnProperty("patient_id")){s=t.patient_to_compare?n.patient_to_compare[0]:n.current_patient[0],o=t.patient_to_compare?n.current_patient[0]:n.patient_to_compare[0],st={exam:nt};var gt=parseInt(s.results),ft=parseFloat(o.results),yt=gt-ft,vt={numeric:yt,percent:yt/(-1==Math.sign(yt)?gt:ft)*100};return st.exam=vt,st}return{exam:nt}}n=i.patient_laboratory_exams,nt={numeric:0,percent:0};if(r.previous_appointment.hasOwnProperty("appointment_id")){var bt=n.exam_results.indexOf(t.item),xt=n.exam_results[bt],It=n.exam_results[bt-1];st={exam:nt};if(void 0!==It&&It.hasOwnProperty("appointment_id")){gt=parseInt(xt.results),ft=parseFloat(It.results),vt={numeric:gt-ft,percent:(gt-ft)/ft*100};return st.exam=vt,st}return{exam:nt}}return{exam:nt};case"risk-factor-calc-list":nt={numeric:0,percent:0};if(a){n=i.comparison.diagnostics.risk_factors,st={dosis:nt,daily_dosis:nt};if(n.current_patient.length>0||n.patient_to_compare.length>0){s=t.patient_to_compare?n.patient_to_compare:n.current_patient,o=t.patient_to_compare?n.current_patient:n.patient_to_compare;if(void 0!==s&&void 0!==o){var kt=t.item,wt=o.find(e=>e.name==kt.name);st={calc:nt};if(void 0!==wt&&wt.hasOwnProperty("appointment_id")){gt=parseFloat(kt.results),ft=parseFloat(wt.results);var At=gt-ft,Dt={numeric:At,percent:At/(-1==Math.sign(At)?gt:ft)*100};return st.calc=Dt,st}return{calc:nt}}return{dosis:nt,daily_dosis:nt}}return{dosis:nt,daily_dosis:nt}}n=i.patient_risk_factors;if(r.previous_appointment.hasOwnProperty("appointment_id")){kt=t.item,wt=n.risk_factors_list.previous_list.find(e=>e.name==kt.name),st={calc:nt};if(void 0!==wt&&wt.hasOwnProperty("appointment_id")){gt=parseFloat(kt.results),ft=parseFloat(wt.results),Dt={numeric:gt-ft,percent:(gt-ft)/ft*100};return st.calc=Dt,st}return{calc:nt}}break;case"risk-factor-calc":n=i.patient_risk_factors,nt={numeric:0,percent:0};if(r.previous_appointment.hasOwnProperty("appointment_id")){kt=n.selectedForm,wt=n.risk_factors_calc_list.find(e=>e.appointment_id==r.previous_appointment.appointment_id),st={calc:nt};if(void 0!==wt&&wt.hasOwnProperty("appointment_id")){gt=parseFloat(kt.obj.results),ft=parseFloat(wt.results),Dt={numeric:gt-ft,percent:(gt-ft)/ft*100};return st.calc=Dt,st}return{calc:nt}}return{calc:nt}}},returnNumberSign(e){var t="";return 1==Math.sign(e)&&0!==e&&e!==1/0&&NaN!==e?t="+":-1==Math.sign(e)&&0!==e&&e!==1/0&&NaN!==e?t="":(t="",e=0),t+e},filterFollowUpsAppointments(e,t=!1){var a=this,i=a.patient_appointments;a.FollowUpAppointmentsDialog=!1;var r=i.appointments.indexOf(e);if(i.previous_appointment=r>0?i.appointments[r-1]:{},a.view_dialog)switch(a.view_tab){case"tab-view-3":a.initializeHistory();break;case"tab-view-4":a.initializeAnthropometry();break;case"tab-view-5":a.initializeVitalSigns();break;case"tab-view-6":a.initializePhysicalExams();break;case"tab-view-7":a.initializeElectroCardiograms();break;case"tab-view-8":a.initializeEchocardiograms();break;case"tab-view-9":a.initializeExams(),a.initializeExamsFiles();break;case"tab-view-10":a.initializeFactorsRisk(!0);break;case"tab-view-11":a.initializePlans()}else switch(a.tab){case"tab-3":a.initializeHistory();break;case"tab-4":a.initializeAnthropometry();break;case"tab-5":a.initializeVitalSigns();break;case"tab-6":a.initializePhysicalExams();break;case"tab-7":a.initializeElectroCardiograms();break;case"tab-8":a.initializeEchocardiograms();break;case"tab-9":a.initializeExams(),a.initializeExamsFiles();break;case"tab-10":a.initializeFactorsRisk(a.view_dialog);break;case"tab-11":a.initializePlans()}},searchTemplate(){return this.filtered_templates=this.templates.filter(e=>e.material_name.toLowerCase().includes(this.template_search.toLowerCase()))},getTelephoneInput(e,t){this.editedItem.telephone=t.number.international}}});